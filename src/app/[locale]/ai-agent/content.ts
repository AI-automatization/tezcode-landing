...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    ...
    capabilities: {
      ...
      title: "ИИ-агент, чат-бот, автоматизация —",
      titleAccent: "в чём разница?",
      subtitle:
        "Все три продаются на рынке как «автоматизация», но делают разное. Коротко: простая автоматизация работает по правилу; чат-бот отвечает на вопрос; AI-агент понимает ситуацию, принимает решение и сам доводит работу до конца. Ниже раскрываем каждый вариант, чтобы вы точно знали, за что платите.",
      items: [
        {
          icon: "wrench",
        ...
        {
          icon: "bot",
          title: "ИИ-агент: сам выполняет работу",
        ...
        },
        {
          ...
          desc: "Если задача — только вопросы-ответы: цены, часы работы, адрес, список услуг — ИИ-чат-бот (AI) дешевле и быстрее. В таком случае переплачивать за агента не нужно — говорим это честно на консультации.",
        },
        {
          icon: "zap",
    ...
    examples: {
      ...
      items: [
        ...
        },
        {
          tag: "03",
          title: "Агент отчётов",
          desc: "Каждый день в назначенное время сам собирает данные о продажах, заказах и кассе из систем, анализирует и отправляет руководителю готовую ежедневную сводку в Telegram. На вопрос «сколько мы сегодня продали?» отвечает сам.",
        },
        {
          tag: "04",
        ...
        },
        {
          ...
          desc: "Несколько агентов работают вместе как отделы: продажи, поддержка, отчётность. Этот подход мы обкатываем на собственном продукте — AI Office с агентами 12 отделов. Пока он в разработке, так что как готовый продукт его не обещаем.",
        },
      ],
    },
    cta: {
      ...
      subtitle:
        "На бесплатной 30-минутной консультации вместе посчитаем, какую задачу возьмёт на себя ИИ-агент (AI-агент) и сколько времени это вам сэкономит. Без обязательств.",
    ...
    faq: {
      ...
      title: "Вопросы и",
      titleAccent: "ответы",
      subtitle: "17 самых частых вопросов о создании ИИ-агентов (AI-агентов).",
      items: [
        {
          q: "Что такое ИИ-агент (AI-агент)?",
          a: "ИИ-агент (AI-агент) — это ИИ-система, которая сама выполняет работу: понимает запрос клиента или сотрудника, сама принимает решения, действует в подключённых системах (CRM, Telegram, 1C) и ведёт процесс от начала до конца. Простой пример: пришёл лид — агент пообщался, записал данные в CRM, отправил предложение, сделал follow-up. Менеджеру приходит уже готовый «горячий» клиент.",
        },
        {
          q: "ИИ-агент, AI-агент и агент на основе искусственного интеллекта — одно и то же?",
        ...
        {
          q: "Чем ИИ-агент (AI-агент) отличается от чат-бота?",
        ...
        {
          q: "Сколько это стоит?",
          a: "ИИ-агент (AI-агент) от $400 (≈ от 5 млн сум). Точная цена зависит от сложности задачи, количества интеграций и каналов — простой агент вопрос-ответ и агент, подключённый к нескольким системам и принимающий решения, стоят по-разному. Точную сумму даём в письменном предложении после бесплатной консультации. Оплата — 30% предоплата, остальное по этапам проекта.",
        },
        {
        ...
        },
        {
          ...
          a: "Часто именно в малом бизнесе эффект агента заметнее — если в команде из 2-3 человек рутину заберёт агент, у команды освободится время на продажи. Начать можно с одной узкой задачи (например, только приём заказов). А если вам нужны только вопросы-ответы, хватит более дешёвого чат-бота — говорим это честно.",
        },
        {
    ...
    service: {
      name: "Создание ИИ-агентов (AI-агентов) — Tezcode",
      description:
        "Создание ИИ-агентов (AI-агентов) для бизнеса: агент продаж (лид → CRM → follow-up), агент заказов, агент отчётов, HR-агент, агент поддержки и мультиагентный подход «AI-офис». Интеграция с Telegram/CRM/1C/POS, на узбекском и русском. Резидент IT Park. Ташкент и весь Узбекистан.",
      serviceType: "Создание ИИ-агентов / AI agent development",
    },
  },
