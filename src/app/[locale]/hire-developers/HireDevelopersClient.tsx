...
const COPY: Record<Lang, Copy> = {
  ...
  ru: {
    hero: {
      ...
      subhead:
        "ИИ-навыки, свободный английский/русский, 5 часов пересечения с EST, проверенная in-house команда из 8 инженеров. Без агентств, без посредников.",
    ...
    rates: {
      ...
      subtitle:
        "Тот же английский. То же качество кода. Сильнее в ИИ, чем типичный офшор. Пересечение по времени с США лучше, чем у Индии.",
      colTezcode: "Tezcode (UZ)",
      colUs: "США",
      colEe: "Восточная Европа",
      colIndia: "Индия",
      note: "Ставки в час, USD. Tezcode — резидент IT Park (стабильный юридический и налоговый статус, инвойсы в USD).",
      rows: [
        { role: "Frontend (React/Next.js)", tezcode: "$30–45", us: "$80–140", ee: "$50–80", india: "$25–40" },
        { role: "Backend (Python/Node)", tezcode: "$32–48", us: "$90–150", ee: "$55–90", india: "$25–40" },
        { role: "Full-stack senior", tezcode: "$35–50", us: "$100–160", ee: "$60–95", india: "$28–42" },
    ...
    highlights: {
      ...
      title: "Четыре причины, почему нас выбирают зарубежные основатели",
      subtitle: "Мы не маркетплейс. 8 senior-инженеров in-house, лично проверенных CEO.",
      items: [
        {
          icon: "01",
          title: "8 senior in-house",
          desc: "Не фрилансеры. Full-time команда, обученная ИИ-инструментам (Claude, ChatGPT), с опытом парного программирования с Бекзодом Мирзаалиевым (CEO).",
        },
        {
          icon: "02",
          title: "Английский / русский",
          desc: "B2–C1 английский во всей команде. Ежедневные standup на английском. Все коммиты, PR и документация — на английском.",
        },
        {
          icon: "03",
          title: "GMT+5 — 5ч EST",
        ...
        },
        {
          ...
          desc: "Tezcode — резидент IT Park (госпрограмма Узбекистана). Инвойсы в USD, 7 лет налоговых льгот, стандартный NDA + IP transfer.",
        },
      ],
    },
    roles: {
    ...
    models: {
      ...
      subtitle: "Платите только за выполненную работу. Без предоплат, без сборов за подписание.",
      items: [
        {
          name: "Part-time",
          price: "$1,200",
        ...
        },
        {
          ...
          price: "Quote",
          per: "по звонку",
          tagline: "Фиксированный объём, фиксированная цена",
          features: [
            "Чёткие этапы (milestone)",
            "Команда 2–4 инженера",
            "Tech lead + PM включены",
            "Еженедельные демо, оплата по этапам",
            "Для sprint / миграции",
          ],
        },
      ],
    ...
    vetting: {
      ...
      items: [
        ...
        { num: "02", title: "Технический тест", desc: "Алгоритмический тест (LeetCode medium) + system design. Сравниваем с планкой senior-уровня в США." },
    ...
    faq: {
      ...
      items: [
        { q: "Когда можно начать?", a: "1–2 недели. Неделя 1: вводный звонок + подбор + интервью. Неделя 2: договор + onboarding (Slack, Linear, GitHub). Большинство клиентов видят разработчика на standup уже на 8-й день." },
