...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    hero: {
      badge: "Разработка ПО и IT-услуги",
      title1: "IT услуги",
      titleAccent: "для вашего бизнеса",
      title2: "",
      subtitle:
        "Сайты, веб-сервисы, мобильные приложения, CRM и ИИ-решения под ваши задачи. Команда Tezcode находится в Ташкенте и работает удалённо с компаниями Центральной Азии. Объём разработки, интеграции и поддержку согласуем до начала работ.",
    ...
    service: {
      name: "Разработка ПО и IT-услуги — Tezcode",
      description:
        "Разработка сайтов, приложений, CRM и ИИ-решений для бизнеса. Команда в Ташкенте, удалённая работа с компаниями Центральной Азии.",
