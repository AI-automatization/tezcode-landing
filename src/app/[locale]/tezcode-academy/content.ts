...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    hero: {
      badge: "TezCode Academy — центр AI-образования",
      title1: "TezCode Academy",
      titleAccent: "— учитесь строить с AI",
      title2: "",
      subtitle:
        "AI-курсы, буткемпы, воркшопы и корпоративные тренинги для разработчиков и владельцев бизнеса. Практика на первом месте — вы учитесь у инженеров действующей AI Software Factory.",
      trust: "Бесплатная 30-мин консультация • Практические проекты • От действующей команды",
    ...
    capabilities: {
      ...
      items: [
        { icon: "book-open", title: "AI-курсы", desc: "Искусственный интеллект, prompt engineering, AI-агенты и основы RAG. С нуля, каждый урок на реальном примере." },
        ...
        { icon: "bar-chart-2", title: "AI-воркшоп для бизнеса", desc: "Для владельцев и менеджеров: где AI приносит пользу и как автоматизировать процессы." },
        { icon: "users", title: "Корпоративный тренинг", desc: "Обучаем вашу команду у вас в офисе или онлайн. Ускоряем ваших разработчиков с помощью AI-инструментов." },
    ...
    process: {
      ...
      steps: [
        ...
        { num: "02", title: "Учимся создавая", desc: "Каждый урок — реальный код и реальная задача. Работаем современно, с AI-инструментами.", icon: "zap" },
    ...
    examples: {
      ...
      items: [
        ...
        { tag: "02", title: "AI-first программа", desc: "Наша программа построена вокруг современных AI-инструментов. Вы осваиваете способ работы будущего уже сегодня." },
    ...
    faq: {
      ...
      items: [
        { q: "Для кого TezCode Academy?", a: "Для двух категорий: разработчики (от новичков до опытных) и владельцы бизнеса/менеджеры. Разработчики осваивают современную инженерию и AI-инструменты, а владельцы бизнеса понимают, где AI приносит пользу." },
        { q: "Нужны ли предварительные знания?", a: "Зависит от формата. AI-курсы и бизнес-воркшоп открыты для новичков. Для буткемпа достаточно уверенно работать за компьютером и понимать базовую логику — остальному научим вместе." },
        ...
        { q: "Проводите ли корпоративные тренинги?", a: "Да. Обучаем команду вашей компании по AI и современной инженерии — составляем программу под ваши потребности и технологии. Детали согласуем на консультации." },
        ...
        { q: "Сколько это стоит?", a: "Точная цена зависит от формата, длительности и выбора группа/индивидуально. Консультация бесплатна — на ней вместе определим подходящее направление и условия." },
      ],
    },
    related: {
      ...
      links: [
        ...
        { href: "/blog", label: "Блог", desc: "Практические статьи и руководства по AI, автоматизации и современной инженерии." },
        { href: "/ai-agent", label: "AI-агенты", desc: "Как AI-агенты работают в бизнесе — посмотрите реальные решения." },
      ],
    },
    service: {
      name: "TezCode Academy — центр AI-образования, Ташкент",
      description:
        "TezCode Academy — центр AI-образования Tezcode. AI-курсы, буткемпы, воркшопы и корпоративные тренинги для разработчиков и владельцев бизнеса. Практика на первом месте, от инженеров действующей Software Factory.",
      serviceType: "Образование / курсы по AI и программированию",
    },
  },
