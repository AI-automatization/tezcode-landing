...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    ...
    capabilities: {
      ...
      subtitle: "Торговля, сфера услуг, склад, отчётность — любая ручная работа, где много времени и ошибок, заслуживает ИИ-автоматизации (AI). Самые частые запросы.",
      items: [
    ...
    pricing: {
      badge: "Цена",
      title: "Сколько стоит",
      titleAccent: "ИИ-автоматизация?",
      subtitle:
        "Цена за проект начинается от $400 (≈ от 5 млн сум). Точная сумма зависит от количества процессов и их сложности — после бесплатного аудита даём письменное предложение.",
      factors: [
        { title: "Простая ИИ-автоматизация", price: "от $400 (≈ от 5 млн сум)", desc: "Telegram-бот или автоматический отчёт — один самый затратный по времени процесс. Быстрый старт для малого бизнеса, 1-2 недели." },
      ...
      note:
        "ИИ-автоматизация начинается от $400 (≈ от 5 млн сум). Оплата: 30% предоплата, остальное поэтапно, по результату. Точная цена — после бесплатной консультации и аудита процессов в письменном предложении.",
    },
    cta: {
      badge: "Время начать",
      title: "Какой процесс",
    ...
    faq: {
      ...
      items: [
        { q: "Что такое ИИ-автоматизация бизнеса (AI)?", a: "ИИ-автоматизация (AI) бизнеса — это выполнение повторяющейся ручной работы (отчёты, заказы, контроль склада, связь с клиентом) с помощью программной системы автоматически. Цель: экономить время, снижать ошибки и видеть реальные цифры." },
