...
export const CONTENT: ServicePageContent = {
  uz: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "📊", title: "Hisobot va analitika", desc: "Savdo, xarajat, foyda bir joyda. Kunlik va oylik hisobot avtomatik tuziladi — Excel'ni qo'lda yangilash kerak emas." },
        { icon: "🧾", title: "Buyurtma va sotuv", desc: "Buyurtma qabul qilish, holatini kuzatish, mijozga avtomatik xabar. Hech bir buyurtma yo'qolmaydi yoki unutilmaydi." },
        { icon: "📦", title: "Ombor va inventarizatsiya", desc: "Qoldiqni real vaqtda ko'rish, mahsulot tugaganda ogohlantirish, ta'minotchiga buyurtma eslatma." },
        { icon: "👥", title: "Mijozlar (CRM)", desc: "Barcha mijoz tarixi, eslatmalar, takroriy sotuv. Mijoz kim, qachon nima olgani — bitta joyda." },
        { icon: "💸", title: "Moliya va to'lovlar", desc: "Kirim-chiqim nazorati, to'lov eslatmalari, qarzdorlik hisobi. Pul oqimi shaffof ko'rinadi." },
        { icon: "🔗", title: "Integratsiya", desc: "Telegram, Google Sheets, 1C, to'lov tizimi, kassa — barchasini bitta avtomatik oqimga bog'laymiz." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Bepul konsultatsiya", desc: "Hozirgi ish jarayoningizni o'rganamiz: qaysi qadam ko'p vaqt oladi, qayerda xato chiqadi. Majburiyat yo'q.", icon: "💬" },
        { num: "02", title: "Jarayon auditi + taklif", desc: "Qaysi jarayonni avtomatlashtirish foydali — aniq reja, narx va muddat bilan yozma taklif.", icon: "🔍" },
        { num: "03", title: "MVP yaratish", desc: "2-4 hafta ichida ishlovchi tizim. Har hafta ko'rsatamiz, siz sinab fikr berasiz.", icon: "⚡" },
        { num: "04", title: "Joriy etish + qo'llab-quvvatlash", desc: "Jamoangizni o'rgatamiz, tizimga ulaymiz, ishlashini kuzatamiz va yaxshilab boramiz.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Real misollar",
  ...
  ru: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "📊", title: "Отчёты и аналитика", desc: "Продажи, расходы, прибыль в одном месте. Ежедневный и месячный отчёт строится автоматически — не нужно вручную обновлять Excel." },
        { icon: "🧾", title: "Заказы и продажи", desc: "Приём заказа, отслеживание статуса, автоуведомление клиенту. Ни один заказ не теряется и не забывается." },
        { icon: "📦", title: "Склад и инвентаризация", desc: "Остатки в реальном времени, оповещение о заканчивающемся товаре, напоминание о заказе поставщику." },
        { icon: "👥", title: "Клиенты (CRM)", desc: "Вся история клиента, напоминания, повторные продажи. Кто клиент, когда и что покупал — в одном месте." },
        { icon: "💸", title: "Финансы и платежи", desc: "Контроль прихода-расхода, напоминания об оплате, учёт задолженности. Денежный поток прозрачен." },
        { icon: "🔗", title: "Интеграция", desc: "Telegram, Google Sheets, 1C, платёжная система, касса — соединяем всё в единый автоматический поток." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Бесплатная консультация", desc: "Изучаем текущий процесс: какой шаг отнимает время, где возникают ошибки. Без обязательств.", icon: "💬" },
        { num: "02", title: "Аудит процессов + предложение", desc: "Какой процесс выгодно автоматизировать — план, цена и срок в письменном виде.", icon: "🔍" },
        { num: "03", title: "Создание MVP", desc: "Рабочая система за 2-4 недели. Показываем каждую неделю, вы тестируете и даёте обратную связь.", icon: "⚡" },
        { num: "04", title: "Внедрение + поддержка", desc: "Обучаем команду, подключаем к системе, следим за работой и улучшаем.", icon: "🚀" },
      ],
    },
    examples: {
  ...
  en: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "📊", title: "Reports & analytics", desc: "Sales, costs, profit in one place. Daily and monthly reports build automatically — no manual Excel updates." },
        { icon: "🧾", title: "Orders & sales", desc: "Take orders, track status, auto-notify the customer. No order is lost or forgotten." },
        { icon: "📦", title: "Inventory", desc: "Real-time stock, low-stock alerts, reorder reminders to suppliers." },
        { icon: "👥", title: "Customers (CRM)", desc: "Full customer history, reminders, repeat sales. Who the customer is, when and what they bought — in one place." },
        { icon: "💸", title: "Finance & payments", desc: "Income-expense control, payment reminders, debt tracking. Cash flow becomes transparent." },
        { icon: "🔗", title: "Integration", desc: "Telegram, Google Sheets, 1C, payment gateways, POS — wired into one automated flow." },
      ],
    },
    process: {
      badge: "How we work",
      ...
      steps: [
        { num: "01", title: "Free consultation", desc: "We study your current process: which step eats time, where errors appear. No obligations.", icon: "💬" },
        { num: "02", title: "Process audit + proposal", desc: "Which process is worth automating — a clear plan, price and timeline in writing.", icon: "🔍" },
        { num: "03", title: "Build the MVP", desc: "A working system in 2-4 weeks. We demo weekly, you test and give feedback.", icon: "⚡" },
        { num: "04", title: "Rollout + support", desc: "We train your team, connect it to your systems, monitor and keep improving.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Real examples",
  ...
  ar: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "📊", title: "التقارير والتحليلات", desc: "المبيعات والمصاريف والأرباح في مكان واحد. يُبنى التقرير اليومي والشهري تلقائياً — بلا تحديث يدوي لـ Excel." },
        { icon: "🧾", title: "الطلبات والمبيعات", desc: "استقبال الطلب، تتبع الحالة، إشعار تلقائي للعميل. لا يضيع أي طلب ولا يُنسى." },
        { icon: "📦", title: "المخزون والجرد", desc: "أرصدة فورية، تنبيه عند نفاد المنتج، تذكير بإعادة الطلب للمورّد." },
        { icon: "👥", title: "العملاء (CRM)", desc: "كل سجل العميل، التذكيرات، المبيعات المتكررة. من العميل ومتى وماذا اشترى — في مكان واحد." },
        { icon: "💸", title: "المالية والمدفوعات", desc: "مراقبة الدخل والمصروف، تذكير بالدفع، حساب الديون. يصبح التدفق النقدي شفافاً." },
        { icon: "🔗", title: "التكامل", desc: "Telegram وGoogle Sheets و1C وبوابة الدفع ونقطة البيع — نربطها في تدفق تلقائي واحد." },
      ],
    },
    process: {
      badge: "كيف نعمل",
      ...
      steps: [
        { num: "01", title: "استشارة مجانية", desc: "ندرس عمليتك الحالية: أي خطوة تستهلك الوقت، وأين تظهر الأخطاء. بلا التزام.", icon: "💬" },
        { num: "02", title: "تدقيق العمليات + عرض", desc: "أي عملية يستحق أتمتتها — خطة وسعر وموعد مكتوبة.", icon: "🔍" },
        { num: "03", title: "بناء MVP", desc: "نظام عامل خلال 2-4 أسابيع. نعرض كل أسبوع، وأنت تختبر وتعطي ملاحظات.", icon: "⚡" },
        { num: "04", title: "التطبيق + الدعم", desc: "ندرّب فريقك، نربطه بأنظمتك، نراقب ونحسّن.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "أمثلة حقيقية",
  ...
  uk: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "📊", title: "Звіти та аналітика", desc: "Продажі, витрати, прибуток в одному місці. Щоденний і місячний звіт будується автоматично — не треба вручну оновлювати Excel." },
        { icon: "🧾", title: "Замовлення та продажі", desc: "Прийом замовлення, відстеження статусу, автосповіщення клієнту. Жодне замовлення не губиться і не забувається." },
        { icon: "📦", title: "Склад та інвентаризація", desc: "Залишки в реальному часі, сповіщення про закінчення товару, нагадування про замовлення постачальнику." },
        { icon: "👥", title: "Клієнти (CRM)", desc: "Уся історія клієнта, нагадування, повторні продажі. Хто клієнт, коли і що купував — в одному місці." },
        { icon: "💸", title: "Фінанси та платежі", desc: "Контроль приходу-витрат, нагадування про оплату, облік заборгованості. Грошовий потік прозорий." },
        { icon: "🔗", title: "Інтеграція", desc: "Telegram, Google Sheets, 1C, платіжна система, каса — поєднуємо все в єдиний автоматичний потік." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Безкоштовна консультація", desc: "Вивчаємо поточний процес: який крок забирає час, де виникають помилки. Без зобов'язань.", icon: "💬" },
        { num: "02", title: "Аудит процесів + пропозиція", desc: "Який процес вигідно автоматизувати — план, ціна та термін письмово.", icon: "🔍" },
        { num: "03", title: "Створення MVP", desc: "Робоча система за 2-4 тижні. Показуємо щотижня, ви тестуєте і даєте відгук.", icon: "⚡" },
        { num: "04", title: "Впровадження + підтримка", desc: "Навчаємо команду, підключаємо до системи, стежимо за роботою і покращуємо.", icon: "🚀" },
      ],
    },
    examples: {
