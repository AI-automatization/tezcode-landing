...
const COPY: Record<Lang, Copy> = {
  ...
  ru: {
    ...
    items: [
      ...
      { name: "AI чат-бот", desc: "Поддержка клиентов 24/7 в Telegram, Instagram и на сайте", price: "от $339" },
      { name: "AI-агент", desc: "Цифровой сотрудник, который не просто отвечает, а сам выполняет работу", price: "от $400" },
      ...
      { name: "AI-видеоаналитика", desc: "Делаем существующие IP-камеры умными — разовое подключение", price: "от $990" },
