...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "bot", title: "ИИ-агенты (AI)", desc: "Агенты, которые сами принимают решения и доводят задачу до конца: продажи, квалификация лидов, поддержка клиентов, внутренняя автоматизация. Цена от $400 (≈ от 5 млн сум)." },
        { icon: "message-circle", title: "ИИ-чат-боты", desc: "Чат-бот, отвечающий 24/7 в Telegram, Instagram, WhatsApp и на сайте: цены, каталог, статус заказа — на узбекском и русском. Цена от $339 (≈ от 4 млн сум)." },
        { icon: "zap", title: "Автоматизация процессов", desc: "Отчёты, заявки и документооборот передаются ИИ: отчёт, занимавший 3 часа, готов за 1 минуту, а ошибки ручного ввода сокращаются на 90%." },
        { icon: "monitor", title: "ИИ-видеоаналитика", desc: "Существующие камеры становятся умными: детекция и подсчёт людей, учёт посещаемости по лицам, охрана труда (каска/форма), распознавание автономеров (ANPR). Цена от $990 (≈ от 12,5 млн сум)." },
        ...
        { icon: "link-2", title: "Интеграция с 1C / CRM", desc: "ИИ работает внутри ваших систем: 1C, amoCRM, Bitrix24, Google Sheets, Click/Payme. Услуга CRM-интеграции от $700 (≈ от 8,5 млн сум)." },
      ],
    },
    tech: {
      badge: "Технологии",
      ...
      items: [
        ...
        { name: "LangChain / LangGraph", desc: "Многошаговая автоматизация: вызов инструментов, условные потоки, совместная работа нескольких ИИ-агентов." },
        { name: "RAG (Retrieval-Augmented Generation)", desc: "ИИ отвечает на основе вашей базы — цены, документы, FAQ — и ничего не выдумывает." },
    ...
    process: {
      ...
      steps: [
        ...
        { num: "03", title: "Создание MVP", desc: "За 2-4 недели — первая рабочая версия. Каждую неделю демо: вы тестируете на реальных данных и даёте обратную связь — так мы корректируем курс на раннем этапе.", icon: "zap" },
    ...
    examples: {
      ...
      items: [
        ...
        { tag: "03", title: "Рестораны и кафе", desc: "POS + ИИ-чат-бот (заказы, бронь) + видеоаналитика (контроль зала) — подробно на отдельной странице для ресторанов." },
        ...
        { tag: "06", title: "Производство и офисы", desc: "Контроль сотрудников WorkControl, ИИ-видеоаналитика (посещаемость, охрана труда), автоматические отчёты." },
      ],
    },
    pricing: {
      badge: "Цены",
      ...
      factors: [
        { title: "Готовые ИИ-решения (AI)", price: "от $279 (≈ от 3,5 млн сум)", desc: "Telegram-бот от $279 (≈ от 3,5 млн сум), ИИ-чат-бот от $339 (≈ от 4 млн сум), ИИ-агент от $400 (≈ от 5 млн сум), ИИ-видеоаналитика от $990 (≈ от 12,5 млн сум) — самый быстрый способ начать." },
        { title: "Подписочные тарифы", price: "$0 – $200/мес (≈ 0 – 2,5 млн сум/мес)", desc: "Starter — $0 (стартовые возможности для малого бизнеса), Pro — $200/мес ≈ 2,5 млн сум/мес (продвинутый ИИ (AI), до 30 сотрудников, поддержка 24/7)." },
        { title: "Индивидуальный проект", price: "MVP от $1000 (≈ от 12 млн сум)", desc: "ИИ-решение, построенное с нуля под ваш процесс: глубокая интеграция (1C, CRM, платёжные системы). Точная цена — после утверждения ТЗ." },
      ],
      ...
      items: [
        {
          ...
          a: "Готовые решения: Telegram-бот от $279 (≈ от 3,5 млн сум), ИИ-чат-бот от $339 (≈ от 4 млн сум), ИИ-агент от $400 (≈ от 5 млн сум), ИИ-видеоаналитика от $990 (≈ от 12,5 млн сум), индивидуальный проект (MVP) от $1000 (≈ от 12 млн сум). Подписочные тарифы: Starter $0, Pro $200/мес (≈ 2,5 млн сум/мес). Точная цена даётся в письменном предложении после бесплатной консультации и ТЗ. Оплата: 30% предоплата, остальное поэтапно — без скрытых доплат.",
        },
        {
          q: "Работает ли ИИ (AI) на узбекском языке?",
