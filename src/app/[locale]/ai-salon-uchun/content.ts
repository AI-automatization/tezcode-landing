...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    hero: {
      ...
      title2: "",
      subtitle:
        "ИИ (AI) и автоматизация для салона красоты — это решение, которое связывает онлайн-запись, напоминания, базу клиентов и лояльность в одну систему и облегчает работу администратора. ИИ-чат-бот принимает запись в Telegram и Instagram 24/7, шлёт напоминания и снижает неявки, пишет клиента в CRM. Tezcode — AI Software Factory в Ташкенте — внедряет это в салонах, барбершопах и клиниках на узбекском и русском.",
