...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    hero: {
      badge: "ИИ (AI) для салона — Ташкент",
      title1: "Для салона красоты —",
      titleAccent: "ИИ и онлайн-запись",
      title2: "",
      subtitle:
        "ИИ (AI) и автоматизация для салона красоты — это решение, которое связывает онлайн-запись, напоминания, базу клиентов и лояльность в одну систему и облегчает работу администратора. ИИ-чат-бот принимает запись в Telegram и Instagram 24/7, шлёт напоминания и снижает неявки, заносит клиента в CRM. Tezcode — AI Software Factory в Ташкенте — внедряет это в салонах, барбершопах и клиниках на узбекском и русском.",
    ...
    capabilities: {
      ...
      items: [
        ...
        { icon: "message-circle", title: "ИИ-чат-бот (AI) отвечает", desc: "Цена, услуги, часы работы, адрес — на частые вопросы бот отвечает мгновенно, не отвлекая администратора." },
    ...
    examples: {
      ...
      items: [
        ...
        { tag: "03", title: "Косметология / клиника", desc: "Запись на приём и процедуру, напоминание о подготовке — здесь помогает наш медицинский опыт CoreMed." },
    ...
    tech: {
      ...
      items: [
        { name: "Бот на узбекском и русском", desc: "Бот естественно работает на узбекском (латиница/кириллица) и русском — клиент свободно записывается на своём языке. Готовые зарубежные платформы не справляются именно с этим." },
    ...
    pricing: {
      ...
      factors: [
        { title: "Бот записи (Telegram/Instagram)", price: "от $279 (≈ от 3,5 млн сум)", desc: "Онлайн-запись, выбор мастера/времени, автонапоминания. Быстрый старт для частного мастера и небольшого салона." },
        { title: "Запись + ИИ + CRM", price: "По проекту", desc: "ИИ (AI) на свободные вопросы, база клиентов, история и лояльность. ИИ-чат-бот от $339 (≈ от 4 млн сум)." },
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Сколько это стоит?", a: "Бот записи от $279 (≈ от 3,5 млн сум). С ИИ (ответы на свободные вопросы), CRM и лояльностью цена растёт — ИИ-чат-бот от $339 (≈ от 4 млн сум). Точная сумма — письменно после ТЗ." },
        ...
        { q: "Кто делает бота для салона в Ташкенте?", a: "Tezcode — AI Software Factory в Ташкенте и резидент IT Park — внедряет онлайн-запись, ИИ-чат-бота и CRM для салонов красоты, барбершопов и клиник. Приходите на бесплатную консультацию." },
      ],
    },
    related: {
    ...
    service: {
      name: "ИИ (AI) и онлайн-запись для салона красоты — Tezcode",
      description:
        "ИИ (AI) и автоматизация для салона красоты, барбершопа и клиники в Ташкенте: онлайн-запись в Telegram/Instagram, автонапоминания (снижение неявок), ИИ-чат-бот, база клиентов и лояльность. На узбекском и русском. Tezcode — резидент IT Park, Узбекистан.",
      serviceType: "Автоматизация салона / ИИ для салона красоты",
    },
  },
  en: {
    hero: {
