...
> = {
  ...
  ru: {
    ...
    description:
      "Честное сравнение amoCRM и Bitrix24: цена (amoCRM ~$15, у Bitrix24 есть бесплатный тариф), возможности и кому что подходит. Какую CRM выбрать в Узбекистане. Tezcode — интегратор, подключающий обе, от $700.",
