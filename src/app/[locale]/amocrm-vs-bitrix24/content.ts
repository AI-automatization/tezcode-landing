...
export const CONTENT: ComparisonContent = {
  ...
  ru: {
    ...
    verdicts: [
      ...
      { name: "Выбирайте Bitrix24, если", when: "хотите всё в одной системе", desc: "Если кроме CRM нужны управление проектами, внутренний портал, документы и задачи — или бюджет ограничен и вы хотите начать с бесплатного тарифа. Лучше подходит крупным командам с несколькими отделами." },
    ],
    faq: {
