  ...
  ru: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Сколько стоят amoCRM и Bitrix24?", a: "amoCRM — от ~$15/пользователь/мес (бесплатного тарифа нет, только пробный). У Bitrix24 есть бесплатный тариф до 12 пользователей, далее от ~$19/пользователь/мес. Точная цена зависит от числа пользователей и тарифа. Лицензию всегда оплачивает клиент — Tezcode делает только подключение и настройку (от $700)." },
        ...
        { q: "Кто подключит amoCRM или Bitrix24 в Ташкенте?", a: "Tezcode — AI Software Factory в Ташкенте и резидент IT Park — подключает amoCRM и Bitrix24 (а также HubSpot, 1C, Sales Doctor) к Telegram, Instagram, WhatsApp, сайту и телефонии, настраивает воронку и переносит старую базу. Цена от $700." },
      ],
    },
    cta: {
      badge: "Следующий шаг",
      ...
      subtitle: "amoCRM или Bitrix24 — мы подключим к вашим каналам, настроим воронку и перенесём базу. От $700. На бесплатной консультации подскажем, какая подходит именно вам.",
