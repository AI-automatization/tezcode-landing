...
export const CONTENT: ServicePageContent = {
  uz: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "💬", title: "24/7 mijoz xizmati", desc: "Telegram, Instagram Direct, WhatsApp va veb-saytda kechayu kunduz javob beradi. Tez-tez beriladigan savollarga o'zi javob beradi." },
        { icon: "🔥", title: "Lidlarni saralash (Cold/Warm/Hot)", desc: "AI har bir mijozning 'qiziqish darajasini' aniqlaydi va tayyor (issiq) mijozni darhol operatorga to'liq kontekst bilan uzatadi." },
        { icon: "📚", title: "Sizning bazangiz bo'yicha javob (RAG)", desc: "AI sizning hujjatlar, narx va xizmatlaringiz asosida aniq javob beradi — umumiy ChatGPT emas, sizning biznesingizni biladi." },
        { icon: "🔗", title: "CRM va 1C integratsiyasi", desc: "AmoCRM, Bitrix24, 1C, Google Sheets — yordamchi mavjud tizimingizga ulanadi, mijoz va buyurtmalar avtomatik yoziladi." },
        { icon: "🌐", title: "Ko'p tilli", desc: "O'zbek, rus va ingliz tilida bir vaqtning o'zida muloqot qiladi — mijoz qaysi tilda yozsa, shu tilda javob oladi." },
        { icon: "🛒", title: "Buyurtma va bron qabul qilish", desc: "Mahsulot tanlash, buyurtma rasmiylashtirish, vaqt bron qilish va eslatma yuborish — operatorsiz, bot orqali." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Bepul konsultatsiya", desc: "Mijozlaringiz qanday savol beradi, qaysi ish ko'p vaqt oladi — o'rganamiz. Majburiyat yo'q.", icon: "💬" },
        { num: "02", title: "Stsenariy + taklif", desc: "Yordamchi qaysi savollarga javob beradi, qaysi kanalda ishlaydi — aniq stsenariy, narx va muddat bilan yozma taklif.", icon: "🔍" },
        { num: "03", title: "MVP yaratish", desc: "1-3 hafta ichida ishlovchi AI yordamchi. Sinab ko'rasiz, fikr berasiz, biz sozlaymiz.", icon: "⚡" },
        { num: "04", title: "Joriy etish + qo'llab-quvvatlash", desc: "Kanallar va CRM ga ulaymiz, javoblar sifatini kuzatamiz va yaxshilab boramiz.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Real misollar",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Qancha vaqtda tayyor bo'ladi va narxi qancha?", a: "Oddiy bot — 1-2 hafta, to'liqroq AI yordamchi — 2-3 hafta MVP. Aniq narx konsultatsiyadan keyin beriladi, to'lov esa faqat MVP tayyor bo'lganda boshlanadi." },
  ...
  ru: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "💬", title: "Поддержка клиентов 24/7", desc: "Отвечает круглосуточно в Telegram, Instagram Direct, WhatsApp и на сайте. На частые вопросы отвечает сам." },
        { icon: "🔥", title: "Квалификация лидов (Cold/Warm/Hot)", desc: "AI определяет 'температуру' каждого клиента и сразу передаёт горячего лида менеджеру с полным контекстом." },
        { icon: "📚", title: "Ответы по вашей базе (RAG)", desc: "AI отвечает на основе ваших документов, цен и услуг — не общий ChatGPT, а ассистент, который знает ваш бизнес." },
        { icon: "🔗", title: "Интеграция с CRM и 1C", desc: "AmoCRM, Bitrix24, 1C, Google Sheets — ассистент подключается к вашей системе, клиенты и заказы пишутся автоматически." },
        { icon: "🌐", title: "Многоязычность", desc: "Общается на узбекском, русском и английском одновременно — клиент получает ответ на своём языке." },
        { icon: "🛒", title: "Приём заказов и брони", desc: "Выбор товара, оформление заказа, бронирование времени и напоминания — без оператора, через бота." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Бесплатная консультация", desc: "Какие вопросы задают клиенты, какая работа отнимает время — изучаем. Без обязательств.", icon: "💬" },
        { num: "02", title: "Сценарий + предложение", desc: "На какие вопросы отвечает ассистент, в каких каналах работает — сценарий, цена и срок письменно.", icon: "🔍" },
        { num: "03", title: "Создание MVP", desc: "Рабочий AI-ассистент за 1-3 недели. Вы тестируете, даёте обратную связь, мы настраиваем.", icon: "⚡" },
        { num: "04", title: "Внедрение + поддержка", desc: "Подключаем к каналам и CRM, следим за качеством ответов и улучшаем.", icon: "🚀" },
      ],
    },
    examples: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Сколько времени и сколько стоит?", a: "Простой бот — 1-2 недели, более полный AI-ассистент — MVP за 2-3 недели. Точная цена даётся после консультации, оплата начинается только после готового MVP." },
  ...
  en: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "💬", title: "24/7 customer support", desc: "Answers around the clock on Telegram, Instagram Direct, WhatsApp and your website. Handles FAQs by itself." },
        { icon: "🔥", title: "Lead qualification (Cold/Warm/Hot)", desc: "AI reads each lead's 'temperature' and instantly hands a hot lead to a human with full context." },
        { icon: "📚", title: "Answers from your knowledge base (RAG)", desc: "AI answers from your documents, prices and services — not generic ChatGPT, but an assistant that knows your business." },
        { icon: "🔗", title: "CRM & 1C integration", desc: "AmoCRM, Bitrix24, 1C, Google Sheets — the assistant connects to your system; leads and orders are logged automatically." },
        { icon: "🌐", title: "Multilingual", desc: "Talks in Uzbek, Russian and English at once — customers get a reply in the language they wrote in." },
        { icon: "🛒", title: "Orders & bookings", desc: "Product selection, order checkout, time booking and reminders — handled by the bot, no operator needed." },
      ],
    },
    process: {
      badge: "How we work",
      ...
      steps: [
        { num: "01", title: "Free consultation", desc: "We study what customers ask and which work eats the most time. No obligations.", icon: "💬" },
        { num: "02", title: "Scenario + proposal", desc: "Which questions the assistant answers, which channels it runs in — a scenario, price and timeline in writing.", icon: "🔍" },
        { num: "03", title: "Build the MVP", desc: "A working AI assistant in 1-3 weeks. You test, give feedback, we tune.", icon: "⚡" },
        { num: "04", title: "Rollout + support", desc: "We connect it to channels and CRM, monitor answer quality and keep improving.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Real examples",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How long and how much does it cost?", a: "A simple bot — 1-2 weeks; a fuller AI assistant — an MVP in 2-3 weeks. An exact price comes after the consultation, and you pay only once the MVP is delivered." },
  ...
  ar: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "💬", title: "دعم العملاء 24/7", desc: "يرد على مدار الساعة في Telegram وInstagram Direct وWhatsApp وموقعك. يجيب عن الأسئلة الشائعة بنفسه." },
        { icon: "🔥", title: "تصنيف العملاء (Cold/Warm/Hot)", desc: "يحدد الذكاء الاصطناعي 'حرارة' كل عميل ويحوّل العميل الجاهز فوراً إلى موظف مع السياق الكامل." },
        { icon: "📚", title: "إجابات من قاعدتك (RAG)", desc: "يجيب الذكاء الاصطناعي اعتماداً على مستنداتك وأسعارك وخدماتك — ليس ChatGPT عاماً بل مساعد يعرف أعمالك." },
        { icon: "🔗", title: "تكامل مع CRM و1C", desc: "AmoCRM وBitrix24 و1C وGoogle Sheets — يتصل المساعد بنظامك، ويُسجَّل العملاء والطلبات تلقائياً." },
        { icon: "🌐", title: "متعدد اللغات", desc: "يتحدث الأوزبكية والروسية والإنجليزية معاً — يحصل العميل على رد بلغته." },
        { icon: "🛒", title: "استقبال الطلبات والحجوزات", desc: "اختيار المنتج، إتمام الطلب، حجز المواعيد والتذكيرات — عبر البوت دون موظف." },
      ],
    },
    process: {
      badge: "كيف نعمل",
      ...
      steps: [
        { num: "01", title: "استشارة مجانية", desc: "ندرس ما يسأله العملاء وأي عمل يستهلك الوقت. بلا التزام.", icon: "💬" },
        { num: "02", title: "سيناريو + عرض", desc: "أي أسئلة يجيب عنها المساعد، وفي أي قنوات يعمل — سيناريو وسعر وموعد مكتوبة.", icon: "🔍" },
        { num: "03", title: "بناء MVP", desc: "مساعد ذكي عامل خلال 1-3 أسابيع. تختبره وتعطي ملاحظات ونضبطه.", icon: "⚡" },
        { num: "04", title: "التطبيق + الدعم", desc: "نربطه بالقنوات وCRM، نراقب جودة الإجابات ونحسّن.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "أمثلة حقيقية",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "كم يستغرق وكم التكلفة؟", a: "بوت بسيط — 1-2 أسبوع، ومساعد ذكي أكمل — MVP خلال 2-3 أسابيع. يُعطى السعر بعد الاستشارة، والدفع بعد تسليم MVP فقط." },
  ...
  uk: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "💬", title: "Підтримка клієнтів 24/7", desc: "Відповідає цілодобово в Telegram, Instagram Direct, WhatsApp і на сайті. На часті питання відповідає сам." },
        { icon: "🔥", title: "Кваліфікація лідів (Cold/Warm/Hot)", desc: "AI визначає 'температуру' кожного клієнта і відразу передає гарячий лід менеджеру з повним контекстом." },
        { icon: "📚", title: "Відповіді за вашою базою (RAG)", desc: "AI відповідає на основі ваших документів, цін і послуг — не загальний ChatGPT, а асистент, який знає ваш бізнес." },
        { icon: "🔗", title: "Інтеграція з CRM і 1C", desc: "AmoCRM, Bitrix24, 1C, Google Sheets — асистент підключається до вашої системи, клієнти та замовлення пишуться автоматично." },
        { icon: "🌐", title: "Багатомовність", desc: "Спілкується узбецькою, російською та англійською одночасно — клієнт отримує відповідь своєю мовою." },
        { icon: "🛒", title: "Прийом замовлень і броні", desc: "Вибір товару, оформлення замовлення, бронювання часу та нагадування — через бота, без оператора." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Безкоштовна консультація", desc: "Які питання ставлять клієнти, яка робота забирає час — вивчаємо. Без зобов'язань.", icon: "💬" },
        { num: "02", title: "Сценарій + пропозиція", desc: "На які питання відповідає асистент, у яких каналах працює — сценарій, ціна та термін письмово.", icon: "🔍" },
        { num: "03", title: "Створення MVP", desc: "Робочий AI-асистент за 1-3 тижні. Ви тестуєте, даєте відгук, ми налаштовуємо.", icon: "⚡" },
        { num: "04", title: "Впровадження + підтримка", desc: "Підключаємо до каналів і CRM, стежимо за якістю відповідей і покращуємо.", icon: "🚀" },
      ],
    },
    examples: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Скільки часу і скільки коштує?", a: "Простий бот — 1-2 тижні, повніший AI-асистент — MVP за 2-3 тижні. Точна ціна дається після консультації, оплата починається лише після готового MVP." },
