  ...
  ru: {
    ...
    story: {
      ...
      paragraphs: [
        ...
        "Наша миссия проста: систематизировать каждый бизнес с помощью ИИ. Не фрилансеры — весь процесс в одной надёжной команде.",
      ],
    },
    values: {
      badge: "Наши ценности",
      ...
      items: [
        ...
        { icon: "bot", title: "AI-first", desc: "Claude и современные ИИ-инструменты в ежедневной работе. Быстрее, сохраняя качество." },
