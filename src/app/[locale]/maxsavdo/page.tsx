...
import { Store, Package, MessageCircle, BarChart2, ArrowRight } from "lucide-react";
...
export default function MaxSavdoPage() {
  const locale = useLocale() as MaxSavdoLang;
  const t = MAXSAVDO_CONTENT[locale] ?? MAXSAVDO_CONTENT.uz;
      ...
      <section className="relative pt-36 pb-16 px-6 text-center">
        ...
        <Reveal className="relative max-w-3xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="inline-flex items-center gap-1.5 rounded-full border border-[rgba(0,64,255,0.25)] bg-[var(--tc-blue-dim)] text-[var(--tc-blue-text)] text-xs font-600 px-2.5 py-1">
