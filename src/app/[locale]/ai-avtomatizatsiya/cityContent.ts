...
const AI_INTRO: Record<string, Record<ServiceLang, string>> = {
  ...
  andijon: {
    ...
    ru: "Андижан — крупный торгово-промышленный центр Ферганской долины, выделяющийся плотным населением, обширными дехканскими базарами и активным предпринимательством. В такой бизнес-среде с высоким оборотом ИИ-автоматизация берёт на себя общение с клиентами, обработку заявок на продажу и ежедневную отчётность, экономя время и силы.",
  ...
  namangan: {
    ...
    ru: "Наманган — один из крупнейших городов Ферганской долины, известный сильными традициями текстиля, пошива и сельского хозяйства, а также множеством семейных предприятий. Для таких производственно-торговых бизнесов ИИ-автоматизация берёт на себя ответы клиентам, приём заказов и оформление документов.",
  ...
  fargona: {
    ...
    ru: "Фергана — центр долины с широкими, регулярными улицами, живущий сильным сельским хозяйством, продуктовой торговлей и растущим предпринимательством. Для таких быстрооборотных бизнесов ИИ-автоматизация берёт на себя запросы клиентов, процессы продаж и доставки, а также отчётность.",
  ...
  nukus: {
    ...
    ru: "Нукус — столица Каракалпакстана, торговый и административный центр региона, обслуживающий население на обширной территории. В таких географических условиях ИИ-автоматизация берёт на себя общение с клиентами, приём заявок и подготовку документов и отчётов, позволяя вести бизнес стабильно даже на расстоянии.",
  ...
  qarshi: {
    ...
    ru: "Карши — центр Кашкадарьинской области на древних торговых путях, регион газа, энергетики и сельского хозяйства с центральным базаром и активной повседневной торговлей. Для такого бизнеса ИИ-автоматизация берёт на себя обработку обращений клиентов и продаж, подготовку отчётов и документов, заметно облегчая ежедневную нагрузку.",
  ...
  jizzax: {
    ...
    ru: "Джизак — важный транзитный и торговый пункт между Ташкентом и Самаркандом, регион хлопководства и зерна, который быстро растёт благодаря придорожным магазинам и новым торговым точкам. ИИ-автоматизация помогает растущему бизнесу, беря на себя общение с клиентами, обработку лидов и продаж и подготовку отчётов, упрощая управление по мере расширения.",
  ...
  navoiy: {
    ...
    ru: "Навои — крупный горно-металлургический и промышленный город, где со стабильным спросом работают современные супермаркеты, магазины одежды и электроники, рестораны и кафе. Для промышленного и сервисного бизнеса ИИ-решения Tezcode автоматизируют ответы клиентам, обработку заявок и продаж, а также формирование отчётов.",
  ...
  urganch: {
    ...
    ru: "Ургенч — центр Хорезмской области и ворота к туризму Хивы, где рядом с центральным базаром и повседневной торговлей активны сувенирные и ремесленные магазины для туристов. Для туристического и торгового бизнеса ИИ-решения Tezcode автоматизируют общение с клиентами, обработку запросов и заказов, а также работу с документами и отчётами.",
  ...
  termiz: {
    ...
    ru: "Термез — самый южный приграничный город Узбекистана, важный пункт в торговле и транзите с Афганистаном; приграничная торговля, оптовые базы и импортные товары оживляют рынок города. Для торгового и логистического бизнеса ИИ-решения Tezcode автоматизируют обработку клиентских запросов, заказов и документов, а также формирование отчётов.",
