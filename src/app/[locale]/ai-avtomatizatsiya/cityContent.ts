...
const AI_INTRO: Record<string, Record<ServiceLang, string>> = {
  ...
  navoiy: {
    uz: "Navoiy — yirik kon-metallurgiya va sanoat shahri bo'lib, bu yerda zamonaviy supermarketlar, kiyim va elektronika do'konlari, restoran-kafelar barqaror talab bilan ishlaydi. Sanoat va xizmat biznesi uchun Tezcode AI yechimlari mijozlarga javoblar, sotuv va so'rovlarni qayta ishlash hamda hisobotlarni avtomatlashtiradi.",
  ...
  urganch: {
    uz: "Urganch — Xorazm viloyatining markazi va Xiva turizmiga eshik bo'lgan shahar bo'lib, markaziy bozor, kundalik savdo yonida turistlarga mo'ljallangan sovg'a va hunarmandchilik do'konlari faol. Turizm va savdo biznesi uchun Tezcode AI yechimlari mijozlar bilan muloqotni, so'rov va buyurtmalarni qayta ishlashni hamda hujjat va hisobotlarni avtomatlashtiradi.",
  ...
  termiz: {
    uz: "Termiz — O'zbekistonning eng janubidagi chegara shahri bo'lib, Afg'oniston bilan savdo va tranzit oqimida muhim nuqta; chegara savdosi, ulgurji bazalar va import tovarlari shahar bozorini jonlantiradi. Savdo va logistika biznesi uchun Tezcode AI yechimlari mijozlar so'rovlari, buyurtmalar va hujjatlarni qayta ishlashni hamda hisobotlarni avtomatlashtiradi.",
