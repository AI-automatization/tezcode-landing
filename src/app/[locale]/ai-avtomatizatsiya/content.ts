...
export const CONTENT: ServicePageContent = {
  uz: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "bar-chart-2", title: "Avtomatik hisobot", desc: "Excel, 1C, savdo va ombordan ma'lumot o'zi yig'iladi. Kunlik/oylik hisobot soatlab emas, soniyalarda tayyor bo'ladi." },
        { icon: "message-circle", title: "AI mijoz xizmati", desc: "Telegram va veb-saytda 24/7 javob beradigan AI chatbot. Tez-tez beriladigan savollarga o'zi javob beradi, murakkabini operatorga uzatadi." },
        { icon: "shopping-cart", title: "Sotuv va lidlarni avtomatlashtirish", desc: "Yangi mijoz keldi — AI uni qayd qiladi, eslatma yuboradi, kerakli bo'limga yo'naltiradi. Hech bir buyurtma yo'qolmaydi." },
        { icon: "package", title: "Ombor va buyurtma nazorati", desc: "Mahsulot tugayotganda ogohlantirish, buyurtma holatini kuzatish, yetkazib berishni avtomatik xabar qilish." },
        { icon: "file-text", title: "Hujjat va shartnoma tahlili", desc: "AI hujjatlardan kerakli ma'lumotni ajratib oladi, shartnomalarni umumlashtiradi, kerakli javobni topadi." },
        { icon: "link-2", title: "Tizimlarni o'zaro ulash", desc: "Telegram, Google Sheets, 1C, to'lov tizimi, CRM — barchasini bitta avtomatik oqimga bog'laymiz (integratsiya)." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Bepul konsultatsiya", desc: "Biznesingizni o'rganamiz: qaysi ish ko'p vaqt oladi, nimani avtomatlashtirish foydali. Majburiyat yo'q.", icon: "message-circle" },
        { num: "02", title: "AI auditi + taklif", desc: "Qaysi jarayonni AI bajara oladi, qaysi vositalar kerak — aniq reja, narx va muddat bilan yozma taklif.", icon: "search" },
        { num: "03", title: "MVP yaratish", desc: "2-4 hafta ichida ishlovchi AI yechim. Har hafta ko'rsatamiz, siz sinab fikr berasiz.", icon: "zap" },
        { num: "04", title: "Joriy etish + qo'llab-quvvatlash", desc: "Tizimga ulaymiz, jamoangizni o'rgatamiz, ishlashini kuzatamiz va yaxshilab boramiz.", icon: "rocket" },
      ],
    },
    examples: {
      badge: "Real misollar",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "Narxi qancha?", a: "Aniq narx faqat AI auditidan keyin beriladi, chunki har biznes jarayoni har xil. Konsultatsiya bepul, to'lov 30% oldindan, qolgani bosqichma-bosqich." },
  ...
  ru: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "bar-chart-2", title: "Автоматические отчёты", desc: "Данные из Excel, 1C, продаж и склада собираются сами. Ежедневный/месячный отчёт готов за секунды, а не за часы." },
        { icon: "message-circle", title: "ИИ-поддержка клиентов", desc: "AI-чатбот в Telegram и на сайте отвечает 24/7. На частые вопросы отвечает сам, сложные передаёт оператору." },
        { icon: "shopping-cart", title: "Автоматизация продаж и лидов", desc: "Пришёл новый клиент — ИИ фиксирует его, отправляет напоминание, направляет в нужный отдел. Ни одна заявка не теряется." },
        { icon: "package", title: "Контроль склада и заказов", desc: "Оповещение о заканчивающемся товаре, отслеживание статуса заказа, автоуведомления о доставке." },
        { icon: "file-text", title: "Анализ документов и договоров", desc: "ИИ извлекает нужные данные из документов, обобщает договоры, находит нужный ответ." },
        { icon: "link-2", title: "Связывание систем", desc: "Telegram, Google Sheets, 1C, платёжная система, CRM — соединяем всё в единый автоматический поток (интеграция)." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Бесплатная консультация", desc: "Изучаем бизнес: какая работа отнимает время, что выгодно автоматизировать. Без обязательств.", icon: "message-circle" },
        { num: "02", title: "ИИ-аудит + предложение", desc: "Какой процесс может выполнить ИИ, какие инструменты нужны — план, цена и срок в письменном виде.", icon: "search" },
        { num: "03", title: "Создание MVP", desc: "Рабочее ИИ-решение за 2-4 недели. Показываем каждую неделю, вы тестируете и даёте обратную связь.", icon: "zap" },
        { num: "04", title: "Внедрение + поддержка", desc: "Подключаем к системе, обучаем команду, следим за работой и улучшаем.", icon: "rocket" },
      ],
    },
    examples: {
  ...
  en: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "bar-chart-2", title: "Automated reports", desc: "Data from Excel, 1C, sales and inventory is gathered automatically. Daily/monthly reports ready in seconds, not hours." },
        { icon: "message-circle", title: "AI customer support", desc: "An AI chatbot on Telegram and your website answers 24/7. It handles FAQs itself and escalates complex cases to a human." },
        { icon: "shopping-cart", title: "Sales & lead automation", desc: "A new lead arrives — AI logs it, sends reminders, routes it to the right team. No order ever slips through." },
        { icon: "package", title: "Inventory & order control", desc: "Low-stock alerts, order status tracking, automatic delivery notifications." },
        { icon: "file-text", title: "Document & contract analysis", desc: "AI extracts key data from documents, summarises contracts, finds the answer you need." },
        { icon: "link-2", title: "Connecting your systems", desc: "Telegram, Google Sheets, 1C, payment gateways, CRM — we wire them into one automated flow (integration)." },
      ],
    },
    process: {
      badge: "How we work",
      ...
      steps: [
        { num: "01", title: "Free consultation", desc: "We study your business: which work eats the most time, what is worth automating. No obligations.", icon: "message-circle" },
        { num: "02", title: "AI audit + proposal", desc: "Which process AI can run, which tools are needed — a clear plan, price and timeline in writing.", icon: "search" },
        { num: "03", title: "Build the MVP", desc: "A working AI solution in 2-4 weeks. We demo weekly, you test and give feedback.", icon: "zap" },
        { num: "04", title: "Rollout + support", desc: "We connect it to your systems, train your team, monitor and keep improving it.", icon: "rocket" },
      ],
    },
    examples: {
      badge: "Real examples",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How much does it cost?", a: "An exact price comes only after the AI audit, since every business process differs. The consultation is free, payment starts with a 30% deposit, the rest per stage." },
  ...
  ar: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "bar-chart-2", title: "تقارير تلقائية", desc: "تُجمع البيانات من Excel و1C والمبيعات والمخزون تلقائياً. التقرير اليومي/الشهري جاهز في ثوانٍ بدل ساعات." },
        { icon: "message-circle", title: "دعم عملاء بالذكاء الاصطناعي", desc: "شات بوت يرد على Telegram والموقع 24/7. يجيب عن الأسئلة الشائعة ويحوّل المعقد إلى موظف." },
        { icon: "shopping-cart", title: "أتمتة المبيعات والعملاء المحتملين", desc: "وصل عميل جديد — يسجله الذكاء الاصطناعي، يرسل تذكيراً، يوجهه للقسم المناسب. لا يضيع أي طلب." },
        { icon: "package", title: "مراقبة المخزون والطلبات", desc: "تنبيه عند نفاد المنتج، تتبع حالة الطلب، إشعارات تلقائية بالتسليم." },
        { icon: "file-text", title: "تحليل المستندات والعقود", desc: "يستخرج الذكاء الاصطناعي البيانات المهمة من المستندات، يلخص العقود، يجد الإجابة المطلوبة." },
        { icon: "link-2", title: "ربط الأنظمة", desc: "Telegram وGoogle Sheets و1C وبوابة الدفع وCRM — نربطها في تدفق تلقائي واحد (تكامل)." },
      ],
    },
    process: {
      badge: "كيف نعمل",
      ...
      steps: [
        { num: "01", title: "استشارة مجانية", desc: "ندرس أعمالك: أي عمل يستهلك الوقت، وما الذي يستحق الأتمتة. بلا التزام.", icon: "message-circle" },
        { num: "02", title: "تدقيق AI + عرض", desc: "أي عملية يمكن للذكاء الاصطناعي تنفيذها، وأي أدوات تلزم — خطة وسعر وموعد مكتوبة.", icon: "search" },
        { num: "03", title: "بناء MVP", desc: "حل ذكي عامل خلال 2-4 أسابيع. نعرض كل أسبوع، وأنت تختبر وتعطي ملاحظات.", icon: "zap" },
        { num: "04", title: "التطبيق + الدعم", desc: "نربطه بأنظمتك، ندرّب فريقك، نراقب الأداء ونحسّن.", icon: "rocket" },
      ],
    },
    examples: {
      badge: "أمثلة حقيقية",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "كم التكلفة؟", a: "يُعطى السعر الدقيق بعد تدقيق AI فقط، لأن العمليات تختلف. الاستشارة مجانية، والدفع يبدأ بدفعة مقدمة 30% والباقي على مراحل." },
  ...
  uk: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "bar-chart-2", title: "Автоматичні звіти", desc: "Дані з Excel, 1C, продажів і складу збираються самі. Щоденний/місячний звіт готовий за секунди, а не години." },
        { icon: "message-circle", title: "ШІ-підтримка клієнтів", desc: "AI-чатбот у Telegram і на сайті відповідає 24/7. На часті питання відповідає сам, складні передає оператору." },
        { icon: "shopping-cart", title: "Автоматизація продажів і лідів", desc: "Прийшов новий клієнт — ШІ фіксує його, надсилає нагадування, спрямовує у потрібний відділ. Жодна заявка не губиться." },
        { icon: "package", title: "Контроль складу та замовлень", desc: "Сповіщення про закінчення товару, відстеження статусу замовлення, автоповідомлення про доставку." },
        { icon: "file-text", title: "Аналіз документів і договорів", desc: "ШІ витягує потрібні дані з документів, узагальнює договори, знаходить потрібну відповідь." },
        { icon: "link-2", title: "Зв'язування систем", desc: "Telegram, Google Sheets, 1C, платіжна система, CRM — поєднуємо все в єдиний автоматичний потік (інтеграція)." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Безкоштовна консультація", desc: "Вивчаємо бізнес: яка робота забирає час, що вигідно автоматизувати. Без зобов'язань.", icon: "message-circle" },
        { num: "02", title: "ШІ-аудит + пропозиція", desc: "Який процес може виконати ШІ, які інструменти потрібні — план, ціна та термін письмово.", icon: "search" },
        { num: "03", title: "Створення MVP", desc: "Робоче ШІ-рішення за 2-4 тижні. Показуємо щотижня, ви тестуєте і даєте відгук.", icon: "zap" },
        { num: "04", title: "Впровадження + підтримка", desc: "Підключаємо до системи, навчаємо команду, стежимо за роботою і покращуємо.", icon: "rocket" },
      ],
    },
    examples: {
