...
const COPY: Record<Lang, CopyShape> = {
  ...
  ru: {
    ...
    problemParas: [
      ...
      "Состояние склада было совсем неизвестно: какой товар закончился, какой залежался — невозможно понять. Когда приезжал поставщик, список составлялся по телефону и часто оказывался неверным.",
    ...
    solutionParas: [
      ...
      "Первая неделя — установка. Команда Tezcode приехала, импортировала базу товаров (3 400 SKU) из Excel в RAOS. Каждому товару привязали barcode (для новых — распечатали).",
    ...
    timeline: [
      ...
      { week: "Неделя 4", title: "Оптимизация + ИИ", desc: "Подключили AI Office Sales: топ-10 товаров, автоалерты склада, аналитика возврата клиентов. Запущена программа лояльности." },
    ],
