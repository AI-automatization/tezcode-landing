...
const COPY: Record<Lang, CopyShape> = {
  ...
  ru: {
    ...
    solutionParas: [
      ...
      "AI-помощь в диагнозе (ClinicaGo AI) — врач вводит симптомы, AI показывает 3-5 возможных диагнозов с рейтингом (только подсказка, решает врач). Особенно полезно для новых врачей.",
    ],
    quote1:
    ...
    timeline: [
      ...
      { week: "Неделя 6", title: "Полный запуск + AI", desc: "Бумагу убрали. ClinicaGo AI запущен в режиме помощи. Первая неделя — агент поддержки в клинике 8 часов." },
    ],
