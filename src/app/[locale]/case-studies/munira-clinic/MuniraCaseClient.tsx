...
const COPY: Record<Lang, CopyShape> = {
  uz: {
    ...
    solutionTitle: "Carevy + HamshiraGo integratsiyasi",
    solutionParas: [
      "Carevy — klinika boshqaruv tizimi (bemor kartochkasi, tashxis, retsept, to'lov). HamshiraGo — hamshira mobil ilovasi (palata aylanish, dori berish, hayotiy ko'rsatkichlar). Ikkalasi bitta klinika ma'lumot bazasida ishlaydi.",
      ...
      "3-4 hafta — bemor migratsiyasi. 3 yillik 4,200 ta bemor kartochkasi qog'ozdan Carevy'ga ko'chirildi (jamoamiz 2 nafar talaba bilan birgalikda). Har bemor uchun unique ID, telefon raqami bilan SMS xabarnoma sozlandi.",
      ...
      "AI tashxis ko'mak (Carevy AI) — shifokor symptom yozsa, AI 3-5 mumkin tashxisni reyting bilan ko'rsatadi (faqat ko'mak sifatida, qaror shifokorda). Bu yangi shifokorlar uchun ayniqsa foydali.",
    ],
    quote1:
    ...
    timeline: [
      { week: "Hafta 1-2", title: "Apparat sozlash + tizim ulash", desc: "5 ta planshet shifokorlar uchun, qabulxonaga katta ekran, QR-kod tizimi, printer. Carevy server o'rnatish + xavfsizlik (HIPAA-style)." },
      { week: "Hafta 3-4", title: "Ma'lumot migratsiyasi", desc: "4 200 bemor qog'oz kartochkasini Carevy'ga ko'chirish (2 talaba yordamida). Har bemorga unique ID, SMS xabarnoma sozlash." },
      ...
      { week: "Hafta 6", title: "Full launch + AI ulash", desc: "Qog'oz to'liq olib tashlandi. Carevy AI tashxis ko'mak rejimi ishga tushdi. Birinchi hafta support agent klinikada 8 soat." },
    ],
    stackTitle: "Texnologiya stack'i",
    stack: [
      { name: "Carevy", role: "Klinika boshqaruv tizimi (EHR — electron tibbiy karta)" },
      { name: "HamshiraGo", role: "Hamshira mobil ilovasi (palata aylanish, dori, vital)" },
      { name: "Carevy AI Assistant", role: "Tashxis ko'mak (shifokor uchun)" },
  ...
  ru: {
    ...
    metrics: [
      ...
      { label: "Время врача на пациента", before: "—", after: "+45 мин/день", caption: "не на бумаги, на пациента" },
    ],
    ...
    solutionTitle: "Интеграция Carevy + HamshiraGo",
    solutionParas: [
      "Carevy — система управления клиникой (карта, диагноз, рецепт, оплата). HamshiraGo — мобильное приложение для медсестёр (обход палат, лекарства, витальные показатели). Обе работают на одной БД клиники.",
      ...
      "3-4 неделя — миграция пациентов. 4 200 карт за 3 года перенесли с бумаги в Carevy (помогли 2 студента). У каждого пациента unique ID, настроены SMS-уведомления.",
      ...
      "AI-помощь в диагнозе (Carevy AI) — врач вводит симптомы, AI показывает 3-5 возможных диагнозов с рейтингом (только подсказка, решает врач). Особенно полезно для новых врачей.",
    ],
    quote1:
    ...
    timeline: [
      { week: "Недели 1-2", title: "Оборудование + подключение", desc: "5 планшетов врачам, большой экран в приёмной, QR-код, принтер. Установка Carevy сервера + безопасность (HIPAA-style)." },
      { week: "Недели 3-4", title: "Миграция данных", desc: "4 200 пациентов с бумаги в Carevy (с 2 студентами). У каждого unique ID, настройка SMS-уведомлений." },
      ...
      { week: "Неделя 6", title: "Полный запуск + AI", desc: "Бумагу убрали. Carevy AI запущен в режиме помощи. Первая неделя — агент поддержки в клинике 8 часов." },
    ],
    stackTitle: "Технологический стек",
    stack: [
      { name: "Carevy", role: "Система управления клиникой (EHR — электронная карта)" },
      { name: "HamshiraGo", role: "Мобильное приложение медсестры (обход, лекарства, витальные)" },
      { name: "Carevy AI Assistant", role: "Помощь в диагнозе для врача" },
  ...
  en: {
    ...
    solutionTitle: "Carevy + HamshiraGo integration",
    solutionParas: [
      "Carevy — clinic management system (chart, diagnosis, prescription, payment). HamshiraGo — nurse mobile app (rounds, meds, vitals). Both share a single clinic database.",
      ...
      "Weeks 3-4 — patient migration. 4,200 paper charts from 3 years were moved into Carevy (helped by 2 students from our team). Each patient got a unique ID and SMS notifications.",
      ...
      "Carevy AI Assistant — doctor enters symptoms, AI suggests 3-5 possible diagnoses with ranking (purely advisory, doctor decides). Especially useful for newer doctors.",
    ],
    quote1:
    ...
    timeline: [
      { week: "Weeks 1-2", title: "Hardware + system", desc: "5 tablets for doctors, big screen in waiting area, QR code, printers. Carevy server install + security (HIPAA-style)." },
      { week: "Weeks 3-4", title: "Data migration", desc: "4,200 paper charts into Carevy (with 2 students). Unique ID per patient, SMS notifications configured." },
      ...
      { week: "Week 6", title: "Full launch + AI", desc: "Paper retired. Carevy AI Assistant in advisory mode. Support agent on-site 8 hours/day the first week." },
    ],
    stackTitle: "Tech stack",
    stack: [
      { name: "Carevy", role: "Clinic management system (EHR — electronic health record)" },
      { name: "HamshiraGo", role: "Nurse mobile app (rounds, meds, vitals)" },
      { name: "Carevy AI Assistant", role: "Differential diagnosis support for doctors" },
  ...
  ar: {
    ...
    solutionTitle: "تكامل Carevy + HamshiraGo",
    solutionParas: [
      "Carevy — نظام إدارة العيادة (البطاقة، التشخيص، الوصفة، الدفع). HamshiraGo — تطبيق محمول للممرضات (الجولة، الأدوية، العلامات الحيوية). كلاهما على قاعدة بيانات واحدة للعيادة.",
      "أول أسبوعين — التركيب. 5 غرف أطباء تلقت أجهزة لوحية وطابعات. قاعة الانتظار شاشة كبيرة، عند المدخل رمز QR للتسجيل الذاتي.",
      "الأسابيع 3-4 — ترحيل المرضى. 4,200 بطاقة ورقية من 3 سنوات إلى Carevy (بمساعدة طالبين). معرّف فريد لكل مريض، إعداد إشعارات SMS.",
      ...
      "مساعد التشخيص (Carevy AI) — يدخل الطبيب الأعراض، يقترح الذكاء الاصطناعي 3-5 تشخيصات محتملة مع ترتيب (استشاري فقط، القرار للطبيب). مفيد خاصة للأطباء الجدد.",
    ],
    quote1:
    ...
    timeline: [
      { week: "الأسبوعان 1-2", title: "المعدات + النظام", desc: "5 أجهزة لوحية للأطباء، شاشة كبيرة، QR، طابعات. تثبيت خادم Carevy + أمان (HIPAA-style)." },
      { week: "الأسبوعان 3-4", title: "ترحيل البيانات", desc: "4,200 بطاقة ورقية إلى Carevy (مع طالبين). معرّف فريد لكل مريض، إعداد SMS." },
      { week: "الأسبوع 5", title: "تدريب الممرضات", desc: "8 ممرضات تلقّين HamshiraGo، 4 ساعات تدريب + يومان جولة حقيقية (ورق + هاتف بالتوازي)." },
      { week: "الأسبوع 6", title: "إطلاق كامل + AI", desc: "إيقاف الورق. Carevy AI في وضع المساعدة. دعم في الموقع 8 ساعات يوميًا في الأسبوع الأول." },
    ],
    stackTitle: "الحزمة التقنية",
    stack: [
      { name: "Carevy", role: "نظام إدارة العيادة (سجل طبي إلكتروني)" },
      { name: "HamshiraGo", role: "تطبيق ممرضة محمول (جولة، أدوية، علامات)" },
      { name: "Carevy AI Assistant", role: "دعم التشخيص التفريقي للطبيب" },
  ...
  uk: {
    ...
    solutionTitle: "Інтеграція Carevy + HamshiraGo",
    solutionParas: [
      "Carevy — система управління клінікою (картка, діагноз, рецепт, оплата). HamshiraGo — мобільний додаток для медсестер (обхід палат, ліки, вітальні показники). Обидві на одній БД клініки.",
      ...
      "3-4 тиждень — міграція пацієнтів. 4 200 карток за 3 роки перенесли з паперу в Carevy (допомогли 2 студенти). Кожному пацієнту унікальний ID, SMS-сповіщення.",
      ...
      "AI-помічник у діагнозі (Carevy AI) — лікар вводить симптоми, AI показує 3-5 можливих діагнозів з рейтингом (лише підказка, вирішує лікар). Особливо корисно для нових лікарів.",
    ],
    quote1:
    ...
    timeline: [
      { week: "Тижні 1-2", title: "Обладнання + підключення", desc: "5 планшетів лікарям, великий екран у приймальні, QR-код, принтер. Встановлення Carevy + безпека (HIPAA-style)." },
      { week: "Тижні 3-4", title: "Міграція даних", desc: "4 200 пацієнтів з паперу в Carevy (з 2 студентами). Унікальний ID для кожного, SMS-сповіщення." },
      ...
      { week: "Тиждень 6", title: "Повний запуск + AI", desc: "Папір прибрали. Carevy AI у режимі допомоги. Перший тиждень — агент підтримки у клініці 8 годин." },
    ],
    stackTitle: "Технологічний стек",
    stack: [
      { name: "Carevy", role: "Система управління клінікою (EHR — електронна картка)" },
      { name: "HamshiraGo", role: "Мобільний додаток медсестри (обхід, ліки, вітальні)" },
      { name: "Carevy AI Assistant", role: "Допомога в діагнозі для лікаря" },
  ...
  return (
    <main className="relative min-h-screen bg-[var(--tc-ink)] pt-24 pb-32 overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgb(52,211,153) 0%, transparent 70%)",
          filter: "blur(120px)",
        }}
      />
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <Reveal>
          <Link
            href="/case-studies"
            className="inline-block text-sm text-[var(--tc-text-muted)] hover:text-emerald-400 transition-colors mb-8"
          >
            {t.back}
          </Link>
        </Reveal>
        ...
        <Reveal>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-400/10 border border-emerald-400/30 text-xs font-500 text-emerald-400 mb-6 uppercase tracking-[0.3em]">
          ...
          <div className="flex items-center gap-4 mb-10">
            <div className="relative shrink-0 w-16 h-16 rounded-full overflow-hidden ring-2 ring-emerald-400/40">
            ...
            <div className="min-w-0">
              ...
              <div className="inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] uppercase tracking-widest font-500 bg-emerald-400/10 text-emerald-400">
                {t.product}
              </div>
            </div>
          </div>
            ...
            <RevealItem key={i}>
              <div className="p-6 rounded-[var(--tc-radius-lg)] border border-[var(--tc-border)] bg-[var(--tc-surface-2)] h-full">
                ...
                <div className="flex items-baseline gap-3 mb-2 flex-wrap">
                  ...
                  <span
                    className="text-2xl md:text-3xl font-700 text-emerald-400 tabular-nums"
                    style={{ fontFamily: "var(--font-display)" }}
                  >
                    {m.after}
                  </span>
        ...
        <Reveal>
          <blockquote className="relative my-16 p-8 md:p-10 rounded-[var(--tc-radius-xl)] border border-emerald-400/30 bg-[var(--tc-surface-2)]">
            <div className="absolute -top-4 left-8 text-5xl text-emerald-400 leading-none font-700 select-none">
              "
            </div>
            <p
          ...
          {t.timeline.map((step, i) => (
            <RevealItem key={i}>
              <div className="relative pl-8 pb-2 border-l border-[var(--tc-border)]">
                <span className="absolute left-0 top-2 -translate-x-1/2 w-3 h-3 rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(52,211,153,0.6)]" />
                <div className="text-xs text-emerald-400 uppercase tracking-[0.2em] mb-1">
                  {step.week}
                </div>
                <h3
        ...
        <Reveal>
          <div className="relative mt-20 p-10 md:p-14 rounded-[var(--tc-radius-xl)] border border-emerald-400/40 bg-gradient-to-br from-[var(--tc-surface-2)] to-[var(--tc-surface-1)] text-center overflow-hidden">
            <div
              aria-hidden
              className="absolute -top-20 -right-20 w-48 h-48 rounded-full bg-emerald-400 opacity-10 blur-3xl"
            />
            ...
            <div className="flex flex-wrap justify-center gap-3 relative">
              ...
              <Link
                href="/case-studies"
                className="inline-block px-8 py-3.5 rounded-[var(--tc-radius-md)] border border-[var(--tc-border-bright)] text-[var(--tc-text-primary)] font-600 text-sm hover:border-emerald-400 transition-colors"
              >
                {t.ctaSecondary}
              </Link>
            </div>
