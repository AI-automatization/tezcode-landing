...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    ...
    capabilities: {
      ...
      subtitle:
        "Один слой ИИ (AI) обучает ваши существующие камеры нескольким задачам — от подсчёта людей до чтения автономеров. Всё в реальном времени, без оператора, который постоянно смотрит в экран.",
      items: [
