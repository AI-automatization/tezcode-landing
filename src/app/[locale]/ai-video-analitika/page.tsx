...
> = {
  ...
  ru: {
    title: "ИИ-видеоаналитика (AI) — Ташкент",
    description:
      "ИИ-видеоаналитика (AI) в Ташкенте: делаем существующие IP-камеры умными — распознавание людей с ИИ, посещаемость по распознаванию лиц, контроль касок/охраны труда и распознавание автономеров (ANPR). Уведомления в реальном времени, on-premise или облако. Цена: от $990 (≈ от 12 млн сум, разовое подключение). Tezcode — резидент IT Park. Бесплатная консультация.",
    ogTitle: "ИИ-видеоаналитика (AI) — Ташкент | Tezcode",
    ogDescription:
      "Сделайте существующие камеры умными с ИИ (AI): подсчёт людей, посещаемость по лицу, контроль касок, ANPR. Видеоаналитика с ИИ в реальном времени, on-premise или облако. Бесплатная консультация.",
  },
  en: {
