...
import { Search, Package, Truck, ShieldCheck, ArrowRight } from "lucide-react";
...
export default function TezDetalPage() {
  const locale = useLocale() as TezDetalLang;
  const t = TEZDETAL_CONTENT[locale] ?? TEZDETAL_CONTENT.uz;
