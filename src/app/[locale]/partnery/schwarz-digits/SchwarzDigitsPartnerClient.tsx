...
const COPY: Record<Lang, CopyShape> = {
  ...
  ru: {
    ...
    name: "Schwarz Digits",
    role: "Прямой контакт с крупной европейской ИИ-экосистемой через IT Park Uzbekistan",
    intro:
    ...
    aboutParas: [
      "Schwarz Digits — цифровое и технологическое подразделение Schwarz Group, которой принадлежат сети Lidl и Kaufland. Компания строит «суверенную европейскую ИИ-экосистему» — независимую и надёжную ИИ-инфраструктуру для европейского бизнеса.",
      "Schwarz Digits сотрудничает с такими крупными технологическими и консалтинговыми компаниями, как Capgemini, Deloitte, SAP и Intel. Это значит, что, будучи технологическим крылом одной из крупнейших ритейл-групп Европы, компания работает над проектами большого масштаба.",
    ],
    ...
    facts: [
      ...
      { title: "Суверенная ИИ-экосистема", desc: "Schwarz Digits строит независимую ИИ-инфраструктуру для европейского бизнеса." },
    ...
    meetingParas: [
      "Встреча прошла в конце июня 2026 года в Ташкенте, в рамках закрытой конференции IT Park Uzbekistan. Представитель Schwarz Digits презентовал концепцию «Partner Ecosystem & Growth» — как европейские компании строят технологические альянсы за пределами ЕС, какие критерии отбора партнёров и что нужно, чтобы попасть в эту сеть.",
      "Ключевой тезис конференции: «Европа испытывает дефицит ИИ-интеграторов. Там есть деньги, есть задачи, но не хватает команд, которые умеют быстро и практично внедрять».",
    ...
    positionParas: [
      "Скажем честно о нашей стратегии: сейчас мы не гонимся за Европой. Наш приоритет — стать №1 по ИИ-автоматизации бизнеса в Узбекистане. Входящие обращения с сайта, рост позиций по ключевым запросам — это сигналы, что движемся правильно.",
    ...
    faq: [
      { q: "Что такое Schwarz Digits и зачем они пришли в Узбекистан?", a: "Schwarz Digits — цифровое подразделение Schwarz Group (Lidl, Kaufland). Они строят суверенную европейскую ИИ-экосистему и ищут технологических партнёров за пределами Европы — там, где есть сильные инженерные команды." },
      { q: "Почему европейский ИИ-рынок интересен компаниям из Узбекистана?", a: "Европейские компании испытывают дефицит ИИ-интеграторов при высоких зарплатных ожиданиях. Узбекские команды с опытом в автоматизации, LLM и CRM-интеграциях могут предложить сопоставимое качество по более низкой стоимости." },
