...
const COPY: Record<Lang, CopyShape> = {
  ...
  ru: {
    ...
    intro:
      "AI Solution — наш официальный партнёр, который внедряет ИИ-продукты tezcode в бизнес Узбекистана под ключ. tezcode разрабатывает продукт, а AI Solution интегрирует его в реальные бизнес-процессы клиента и сопровождает.",
    statsTitle: "В цифрах",
    stats: [
    ...
    aboutParas: [
      "AI Solution — компания, автоматизирующая бизнес с помощью ИИ по всему Узбекистану и Центральной Азии. Голосовые ИИ-агенты, чат-боты и аналитика помогают компаниям экономить время и затраты.",
      "Как опытный интегратор, компания не просто подключает продукт, а обучает команду, настраивает процессы и оказывает поддержку на русском и узбекском языках.",
    ],
    offeringsTitle: "Что внедряют",
    offerings: [
      { title: "Голосовые ИИ-агенты", desc: "Принимают звонки, консультируют и фиксируют клиентов без живого оператора." },
      { title: "ИИ-чат-боты", desc: "Работают с клиентами 24/7 в Telegram, Instagram и WhatsApp." },
    ...
    partnershipParas: [
      "tezcode — это AI Software Factory: мы разрабатываем, тестируем и развиваем ИИ-продукты. AI Solution — опытный интегратор, который внедряет эти продукты в бизнес клиента.",
