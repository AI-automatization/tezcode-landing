...
export const CONTENT: ServicePageContent = {
  uz: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "🧾", title: "Kassa (POS)", desc: "Tez sotuv: barkod skaner, chek chiqarish, naqd/karta/aralash to'lov, smena yopish. Sotuvchi 1 daqiqada o'rganadi." },
        { icon: "📦", title: "Ombor va qoldiq", desc: "Har mahsulot qoldig'i real vaqtda. Kam qolganda ogohlantirish, kirim/chiqim, inventarizatsiya." },
        { icon: "📡", title: "Internetsiz ishlaydi (offline-first)", desc: "Internet uzilsa ham kassa ishlaydi — ma'lumot lokalda saqlanadi, ulanish tiklanganda avtomatik sinxron." },
        { icon: "👥", title: "Mijozlar va sodiqlik", desc: "Mijoz bazasi, qarz/nasiya, chegirma va sodiqlik (loyalty). Mijoz tarixi bir bosishda." },
        { icon: "📊", title: "Hisobot va analitika", desc: "Kunlik sotuv, foyda, eng ko'p sotilgan mahsulot, sotuvchi samaradorligi — avtomatik hisobot." },
        { icon: "🏪", title: "Ko'p filial / tarmoq", desc: "Bir nechta do'konni bitta dashboarddan boshqaring. Har filial qoldig'i va sotuvi alohida ko'rinadi." },
      ],
    },
    process: {
      ...
      steps: [
        { num: "01", title: "Bepul demo", desc: "Do'koningizni ko'rsatamiz — qanday ishlashini jonli sinab ko'rasiz. Majburiyat yo'q.", icon: "💬" },
        { num: "02", title: "Sozlash + ma'lumot ko'chirish", desc: "Mahsulot bazasi, narx, filiallar — sizning do'koningizga moslab sozlaymiz.", icon: "🔧" },
        { num: "03", title: "O'rgatish", desc: "Sotuvchilar va kassirlarni o'rgatamiz. RAOS sodda — tez o'rganiladi.", icon: "⚡" },
        { num: "04", title: "Ishga tushirish + qo'llab-quvvatlash", desc: "Jonli ishga tushiramiz, ishlashini kuzatamiz, savollarga doimo javob beramiz.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Kimlar uchun",
  ...
  ru: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "🧾", title: "Касса (POS)", desc: "Быстрые продажи: сканер штрихкода, чек, оплата наличными/картой/смешанная, закрытие смены. Продавец учится за минуту." },
        { icon: "📦", title: "Склад и остатки", desc: "Остаток каждого товара в реальном времени. Оповещение о малом остатке, приход/расход, инвентаризация." },
        { icon: "📡", title: "Работает без интернета", desc: "Даже при обрыве связи касса работает — данные хранятся локально и автоматически синхронизируются при восстановлении." },
        { icon: "👥", title: "Клиенты и лояльность", desc: "База клиентов, долг/рассрочка, скидки и программа лояльности. История клиента в один клик." },
        { icon: "📊", title: "Отчёты и аналитика", desc: "Дневные продажи, прибыль, топ-товары, эффективность продавцов — автоматические отчёты." },
        { icon: "🏪", title: "Сеть / много филиалов", desc: "Управляйте несколькими магазинами из одного дашборда. Остаток и продажи каждого филиала отдельно." },
      ],
    },
    process: {
      badge: "Как начинаем",
      ...
      steps: [
        { num: "01", title: "Бесплатное демо", desc: "Покажем на вашем магазине — попробуете вживую. Без обязательств.", icon: "💬" },
        { num: "02", title: "Настройка + перенос данных", desc: "База товаров, цены, филиалы — настроим под ваш магазин.", icon: "🔧" },
        { num: "03", title: "Обучение", desc: "Обучим продавцов и кассиров. RAOS прост — учится быстро.", icon: "⚡" },
        { num: "04", title: "Запуск + поддержка", desc: "Запускаем, следим за работой, всегда отвечаем на вопросы.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Для кого",
  ...
  en: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "🧾", title: "Register (POS)", desc: "Fast sales: barcode scanner, receipts, cash/card/split payment, shift close. A cashier learns it in a minute." },
        { icon: "📦", title: "Inventory & stock", desc: "Every item's stock in real time. Low-stock alerts, stock in/out, stocktaking." },
        { icon: "📡", title: "Works offline (offline-first)", desc: "Even if the internet drops, the register keeps working — data is stored locally and syncs automatically when back online." },
        { icon: "👥", title: "Customers & loyalty", desc: "Customer base, credit/installments, discounts and loyalty. Customer history in one click." },
        { icon: "📊", title: "Reports & analytics", desc: "Daily sales, profit, top products, cashier performance — automatic reports." },
        { icon: "🏪", title: "Multi-branch / chain", desc: "Manage several stores from one dashboard. Each branch's stock and sales tracked separately." },
      ],
    },
    process: {
      badge: "How we start",
      ...
      steps: [
        { num: "01", title: "Free demo", desc: "We show it on your store — you try it live. No obligations.", icon: "💬" },
        { num: "02", title: "Setup + data migration", desc: "Product base, prices, branches — configured for your store.", icon: "🔧" },
        { num: "03", title: "Training", desc: "We train your salespeople and cashiers. RAOS is simple — learned fast.", icon: "⚡" },
        { num: "04", title: "Launch + support", desc: "We go live, monitor it, and always answer your questions.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Who it's for",
  ...
  ar: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "🧾", title: "الكاشير (POS)", desc: "بيع سريع: ماسح باركود، إيصال، دفع نقدي/بطاقة/مختلط، إغلاق الوردية. يتعلمه البائع في دقيقة." },
        { icon: "📦", title: "المخزون والأرصدة", desc: "رصيد كل منتج في الوقت الفعلي. تنبيه عند انخفاض المخزون، إدخال/إخراج، جرد." },
        { icon: "📡", title: "يعمل بدون إنترنت", desc: "حتى عند انقطاع الاتصال يستمر الكاشير — تُخزَّن البيانات محلياً وتُزامَن تلقائياً عند عودة الاتصال." },
        { icon: "👥", title: "العملاء والولاء", desc: "قاعدة العملاء، الدين/التقسيط، الخصومات وبرنامج الولاء. سجل العميل بنقرة واحدة." },
        { icon: "📊", title: "التقارير والتحليلات", desc: "مبيعات يومية، أرباح، أكثر المنتجات مبيعاً، أداء البائعين — تقارير تلقائية." },
        { icon: "🏪", title: "سلسلة / فروع متعددة", desc: "أدر عدة متاجر من لوحة واحدة. رصيد ومبيعات كل فرع على حدة." },
      ],
    },
    process: {
      badge: "كيف نبدأ",
      ...
      steps: [
        { num: "01", title: "عرض تجريبي مجاني", desc: "نعرضه على متجرك — تجربه مباشرة. بلا التزام.", icon: "💬" },
        { num: "02", title: "الإعداد + نقل البيانات", desc: "قاعدة المنتجات، الأسعار، الفروع — نضبطها لمتجرك.", icon: "🔧" },
        { num: "03", title: "التدريب", desc: "ندرّب البائعين والكاشير. RAOS بسيط — يُتعلَّم بسرعة.", icon: "⚡" },
        { num: "04", title: "الإطلاق + الدعم", desc: "نطلقه، نراقب العمل، ونجيب دائماً عن أسئلتك.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "لمن",
  ...
  uk: {
    ...
    capabilities: {
      ...
      items: [
        { icon: "🧾", title: "Каса (POS)", desc: "Швидкі продажі: сканер штрихкоду, чек, оплата готівкою/карткою/змішана, закриття зміни. Продавець вчиться за хвилину." },
        { icon: "📦", title: "Склад і залишки", desc: "Залишок кожного товару в реальному часі. Сповіщення про малий залишок, прихід/витрата, інвентаризація." },
        { icon: "📡", title: "Працює без інтернету", desc: "Навіть при обриві зв'язку каса працює — дані зберігаються локально і синхронізуються автоматично при відновленні." },
        { icon: "👥", title: "Клієнти та лояльність", desc: "База клієнтів, борг/розстрочка, знижки та програма лояльності. Історія клієнта в один клік." },
        { icon: "📊", title: "Звіти та аналітика", desc: "Денні продажі, прибуток, топ-товари, ефективність продавців — автоматичні звіти." },
        { icon: "🏪", title: "Мережа / багато філій", desc: "Керуйте кількома магазинами з однієї панелі. Залишок і продажі кожної філії окремо." },
      ],
    },
    process: {
      badge: "Як починаємо",
      ...
      steps: [
        { num: "01", title: "Безкоштовне демо", desc: "Покажемо на вашому магазині — спробуєте наживо. Без зобов'язань.", icon: "💬" },
        { num: "02", title: "Налаштування + перенос даних", desc: "База товарів, ціни, філії — налаштуємо під ваш магазин.", icon: "🔧" },
        { num: "03", title: "Навчання", desc: "Навчимо продавців і касирів. RAOS простий — вчиться швидко.", icon: "⚡" },
        { num: "04", title: "Запуск + підтримка", desc: "Запускаємо, стежимо за роботою, завжди відповідаємо на питання.", icon: "🚀" },
      ],
    },
    examples: {
      badge: "Для кого",
