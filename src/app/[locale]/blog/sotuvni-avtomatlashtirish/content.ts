...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    ...
    sections: [
      ...
      {
        heading: "Как работает автоматизированная продажа?",
        paragraphs: [
        ...
        bullets: [
          ...
          "2. AI-чат-бот — первый ответ: отвечает 24/7, закрывает вопросы цена/наличие/заказ, квалифицирует лид (/ai-chatbot).",
          "3. Горячий лид → менеджер: готового к покупке клиента передаёт менеджеру с полной историей диалога.",
      ...
      },
      {
        ...
        bullets: [
          "На вопросы в Instagram Direct AI-чат-бот отвечает мгновенно, принимает заказ.",
          "В Telegram полноценный магазин (Mini App): каталог, корзина, оплата Click/Payme — без комиссии (/telegram-bot-biznes).",
          "Клиенты из обоих каналов собираются в одной CRM — менеджер ведёт из одного окна.",
        ],
      },
      {
        heading: "Квалификация лидов (какой клиент горячий?)",
        paragraphs: [
          "Не все обращения равны: один просто спрашивает, другой готов купить. AI-чат-бот определяет это в ходе диалога и направляет менеджера только на горячий лид. Тогда:",
        ],
        bullets: [
          "Время менеджера экономится — он работает только с готовым клиентом.",
          "Холодные лиды получают авто-нёртинг (напоминания, предложения).",
      ...
      items: [
        {
          ...
          a: "Это объединение общения с клиентом, сбора лидов, ответов и закрытия сделки в одной системе без ручного труда. На практике: все каналы (Telegram, Instagram, WhatsApp, сайт) подключаются к CRM, AI-чат-бот отвечает 24/7 и квалифицирует лиды, горячий лид передаётся менеджеру.",
        },
        {
          q: "Как автоматизировать продажи через Instagram и Telegram?",
          a: "Мы связываем Instagram Direct и Telegram с AI-чат-ботом и CRM: бот мгновенно отвечает, принимает заказ, пишет клиента в CRM. В Telegram также строится полноценный магазин Mini App (с оплатой). Оба канала объединяются в один поток.",
        },
        {
          q: "Как AI-чат-бот квалифицирует лид?",
          a: "В ходе диалога AI определяет уровень интереса клиента: кто просто спрашивает, кто готов купить. Горячий лид сразу передаёт менеджеру с полным контекстом, а холодным уходят авто-напоминания/предложения.",
        },
        {
        ...
        },
        {
          ...
          a: "Автоматизация продаж состоит из частей: AI-чат-бот от $339, Telegram-бот от $279, интеграция CRM от $700. Точная сумма — по составу после ТЗ. Срок обычно 2–4 недели.",
        },
        {
          q: "Кто автоматизирует продажи в Ташкенте?",
          a: "Tezcode — AI Software Factory в Ташкенте и резидент IT Park — автоматизирует продажи: связывает Instagram/Telegram/сайт + AI-чат-бот + CRM/1C в один поток. Приходите на бесплатную консультацию.",
        },
      ],
    },
    cta: {
