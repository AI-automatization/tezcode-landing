...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      badge: "Цены / 2026",
      title: "Цены на AI-решения 2026: сколько стоит каждая услуга? (Ташкент, Узбекистан)",
      subtitle:
        "Точные цены «от» на AI-чат-бот, AI-агента, видеоаналитику, интеграцию CRM и другие решения, что влияет на цену и порядок оплаты — открытое ценовое руководство Tezcode.",
    ...
    tldr: {
      ...
      text:
        "В Узбекистане цены на AI-решения в 2026 обычно начинаются так: AI-чат-бот — от $339, AI-агент — от $400, Telegram-бот — от $279, автоматизация бизнеса — от $400, интеграция CRM (amoCRM, Bitrix24, 1C) — от $700, AI-видеоаналитика — от $990 (разовое подключение), разработка ПО на заказ — от $1000. Подписочные продукты: CRM для клиники от $25/мес, контроль сотрудников от $35/мес, POS-система от 249 000 сум/мес. Точная цена зависит от числа каналов, интеграций и сложности — итоговая сумма даётся письменно после бесплатной консультации и ТЗ. Оплата обычно: 30% предоплата, остальное поэтапно.",
    },
    sections: [
      {
        heading: "От чего зависит цена AI-решения?",
        paragraphs: [
          "В AI-проектах нет единой универсальной цены — у каждого бизнеса свои потребности. Основные факторы, определяющие цену:",
        ],
        bullets: [
          ...
          "Сложность AI: простой FAQ дешевле; ответ по базе знаний (RAG), квалификация лидов или голосовой AI дороже.",
      ...
      },
      {
        ...
        bullets: [
          "AI-чат-бот (Telegram, Instagram, WhatsApp, сайт): от $339 — tezcode.dev/ru/ai-chatbot",
          "AI-агент (сам выполняет задачи, 24/7): от $400 — tezcode.dev/ru/ai-agent",
          ...
          "AI-видеоаналитика (подсчёт людей, распознавание лиц, ANPR): от $990, разовое подключение — tezcode.dev/ru/ai-video-analitika",
      ...
      },
      {
        ...
        paragraphs: [
          "Нет. На рынке есть очень дешёвые предложения вроде «AI от 5 миллионов сум», но часто это оказывается простой кнопочный бот или готовый шаблон. Настоящее AI-решение (база знаний, интеграции, настройка узбекского языка) требует реальной работы.",
    ...
    faq: {
      ...
      items: [
        {
          q: "Сколько стоит AI-чат-бот (2026)?",
          a: "В Tezcode AI-чат-бот стоит от $339. Точная цена зависит от числа каналов (Telegram, Instagram, WhatsApp, сайт), интеграций (CRM, 1C) и сложности AI — итоговая сумма даётся письменно после бесплатной консультации и ТЗ.",
        },
        {
          q: "Сколько стоит AI-агент?",
          a: "AI-агент стоит от $400. Агент дороже чат-бота, потому что не просто отвечает, а выполняет реальные задачи: пишет в CRM/1C, создаёт заказы, интегрируется. Цена зависит от объёма работы.",
        },
        {
        ...
        {
          q: "Сколько стоит AI-видеоаналитика?",
          a: "AI-видеоаналитика стоит от $990 — это разовое подключение (подсчёт людей, распознавание лиц для учёта посещаемости, ANPR). Работает с вашими существующими IP-камерами, затем системой управляете сами.",
        },
        {
