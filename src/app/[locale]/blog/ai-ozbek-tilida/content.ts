...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      badge: "AI / Узбекский язык",
      title: "Работает ли AI на узбекском? Полный ответ для чат-ботов и агентов (2026)",
      subtitle:
        "Многие думают: «Понимает ли AI узбекский?». Честный ответ: современный AI работает на узбекском, но качество зависит от настройки. Почему готовые боты плохо справляются с узбекским и как сделать правильно — объясняем.",
    ...
    tldr: {
      ...
      text:
        "Да, современный AI (модели уровня GPT, Claude) работает на узбекском — в латинице и кириллице, даже при смешанном узбекско-русском тексте. Но качество зависит от настройки: готовые зарубежные платформы (ManyChat, простые боты на ChatGPT) понимают узбекский поверхностно, путают разговорный стиль и отраслевые термины. Для хорошего результата бот нужно отдельно настроить под ваш контент (прайс, услуги, вопросы-ответы) на uz/ru и протестировать на реальных диалогах. Tezcode как раз строит ботов под узбекско-русское общение для бизнеса Узбекистана.",
    },
    sections: [
      {
        heading: "Почему готовые боты плохо справляются с узбекским?",
        paragraphs: [
          "Узбекский язык для AI непрост — по нескольким причинам:",
        ],
        bullets: [
          "Две письменности: узбекский пишут и латиницей, и кириллицей. Многие готовые боты хорошо понимают только одну.",
          "Смешанный язык (code-switching): в Узбекистане люди в одном предложении пишут узбекско-русский микс. Это путает AI.",
      ...
      {
        heading: "Как современный AI понимает узбекский?",
        paragraphs: [
          "Большие языковые модели уровня GPT-4o и Claude уже хорошо знают узбекский — они многоязычны. При правильной настройке:",
        ],
        bullets: [
          "Понимает и латиницу, и кириллицу, и отвечает на них.",
          "Естественно ведёт смешанный (узбекско-русский) диалог.",
          "Отвечает по вашей базе (RAG) — не общий ChatGPT, а именно ваши цены и услуги.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Ограничение, чтобы не выдумывать то, чего нет в базе — вместо неверного ответа передаёт оператору.",
        ],
      },
      {
        heading: "Отличие Tezcode",
        paragraphs: [
          "В Ташкенте много кто делает чат-ботов, но узбекский язык — именно наш фокус:",
          "Мы строим бота на основе ваших документов на узбекском и русском, отдельно настраиваем латиницу/кириллицу и смешанный язык, тестируем на реальных диалогах. Готовые зарубежные платформы падают именно здесь. Подробнее: AI чат-бот (/ai-chatbot), AI агент (/ai-agent).",
        ],
      },
    ],
    faq: {
      ...
      items: [
        {
          q: "Работает ли AI на узбекском?",
          a: "Да. Современный AI (модели уровня GPT, Claude) работает на узбекском — в латинице и кириллице, даже при смешанном узбекско-русском тексте. Но качество зависит от настройки: бот нужно отдельно настроить под вашу базу на uz/ru.",
        },
        {
        ...
        },
        {
          ...
          a: "Да. В Узбекистане часто пишут в одном предложении узбекско-русский микс. Правильно настроенный бот понимает это естественно — на это Tezcode делает особый упор.",
        },
        {
          q: "Что если бот ответит неправильно по-узбекски?",
          a: "Чтобы этого избежать, бот отвечает только по вашей базе и не выдумывает то, чего в ней нет. В неуверенном случае передаёт вопрос оператору. Тестируем на реальных диалогах и постоянно улучшаем качество.",
        },
        {
          q: "Кто делает узбекоязычный AI-чат-бот в Ташкенте?",
          a: "Tezcode — AI Software Factory в Ташкенте и резидент IT Park — создаёт AI-чат-ботов и агентов на узбекском и русском. Строим бота на основе ваших документов, отдельно настраиваем латиницу/кириллицу и смешанный язык. Подробнее: tezcode.dev/ru/ai-chatbot.",
        },
      ],
    },
    cta: {
      title: "Нужен AI, работающий на узбекском?",
      subtitle:
        "На бесплатной консультации Tezcode посмотрит ваш бизнес и определит, какую пользу даст AI-чат-бот или агент на uz/ru. Без обязательств.",
