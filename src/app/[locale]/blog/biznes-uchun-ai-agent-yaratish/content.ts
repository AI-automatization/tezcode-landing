...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      ...
      subtitle:
        "Что такое ИИ-агент, чем он отличается от чат-бота, какому бизнесу нужен, как работает, сколько стоит и как создать его за 6 шагов — практическое руководство для бизнеса в Узбекистане.",
    ...
    tldr: {
      label: "Краткий ответ",
      text:
        "ИИ-агент — это программа, которая не просто отвечает, а доводит задачу до конца: отвечает клиенту, записывает данные в CRM или 1С, оформляет заказ и привлекает сотрудника только при необходимости. Создание ИИ-агента для бизнеса в Ташкенте обычно проходит за 6 шагов: анализ → дизайн → интеграция → тестирование → запуск → поддержка. Цена — это не готовый шаблон, она зависит от ваших потребностей (какая модель, какие интеграции, какая сложность). Tezcode — команда из 16 человек, основанная в Ташкенте в 2024 году — создаёт ИИ-агентов на базе Claude и GPT, работающих на узбекском и русском, и даёт бесплатную консультацию.",
    },
    sections: [
      {
        heading: "Что такое ИИ-агент и чем он отличается от чат-бота?",
        paragraphs: [
          "ИИ-агент — это программа, которая способна самостоятельно принимать решения и выполнять практическую задачу ради достижения цели. Обычный чат-бот отвечает на вопрос текстом и на этом останавливается. ИИ-агент же помимо ответа действует: ищет данные, записывает в систему, создаёт заказ, отправляет счёт или ставит задачу сотруднику.",
          "Покажем разницу на простом примере. Если клиент спрашивает «есть ли шампунь для волос?», обычный чат-бот скажет «да, у нас есть шампуни». ИИ-агент же проверит остаток на складе, найдёт подходящий товар, назовёт цену, при желании клиента оформит заказ в CRM и подаст сигнал в отдел доставки — без участия человека.",
          "То есть главное отличие: чат-бот — разговаривает, агент — выполняет работу. На техническом языке это называют «tool calling» (агент вызывает функции внешних систем) и «оркестрация» (выполнение нескольких шагов подряд). Именно поэтому в 2026 году современные ИИ-агенты стали гораздо полезнее простых ботов «вопрос-ответ».",
          ...
          "Коротко: чат-бот работает по сценарию («если спросили так — ответь так») с ограниченным набором кнопок; ИИ-агент понимает свободный текст, принимает решения и действует во внешних системах. Первое — технология пятилетней давности, второе — стандарт 2026 года.",
        ],
      },
      {
        heading: "Какому бизнесу нужен ИИ-агент?",
        paragraphs: [
          "ИИ-агент нужен не каждому бизнесу в одинаковой мере. Но если есть следующие признаки — это сильный сигнал:",
      ...
      {
        heading: "Типы ИИ-агентов: какой подходит вам?",
        paragraphs: [
      ...
      {
        heading: "Как работает ИИ-агент? (технически, но простым языком)",
        paragraphs: [
          "Многие представляют «ИИ-агента» как волшебную коробку. На деле он состоит из нескольких чётких частей, и каждая выполняет понятную задачу.",
      ...
      {
        heading: "В чём реальная польза от ИИ-агента? (честная оценка)",
        paragraphs: [
      ...
      {
        heading: "Заменяет ли ИИ-агент человека?",
        paragraphs: [
          "Нет. Важный момент: ИИ-агент не заменяет человека полностью. Он берёт на себя повторяющуюся и затратную по времени часть, а ваши сотрудники находят время для ценной работы — сложных сделок и отношений. В правильно построенной системе агент и человек работают вместе: агент на первой линии, человек — в сложных и ценных случаях.",
        ],
      },
      {
        heading: "Как создать ИИ-агента? — 6 шагов",
        paragraphs: [
          "Хороший ИИ-агент — это не просто «включить бота». Надёжный результат проходит через следующие 6 этапов. Этот процесс подробно описан на странице услуги ИИ-агента Tezcode (tezcode.dev/ai-agent), а решения по ИИ-чат-ботам — на странице tezcode.dev/ai-chatbot.",
        ],
        bullets: [
      ...
      {
        heading: "Что понадобится от вас для создания ИИ-агента?",
        paragraphs: [
      ...
      {
        heading: "От чего зависит цена ИИ-агента?",
        paragraphs: [
          "Самый частый вопрос — «сколько стоит?». Честный ответ: готовой цены нет, потому что ИИ-агент как костюм — шьётся по вашим меркам. Цена зависит от:",
        ],
        bullets: [
          ...
          "Объём базы знаний — сколько документов, позиций каталога и правил заложено в агента.",
      ...
      },
      {
        ...
        paragraphs: [
          "Проекты ИИ-агентов чаще проваливаются из-за подхода, а не технологий. Самые распространённые ошибки:",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "Реализовать ИИ-агента можно несколькими путями, и правильный выбор зависит от сложности вашего бизнеса:",
        ],
        bullets: [
      ...
      {
        heading: "Создание ИИ-агента с Tezcode",
        paragraphs: [
          "Tezcode — команда AI Software Factory из 16 человек, основанная в Ташкенте в 2024 году. Мы создаём ИИ-агентов, ИИ-чат-ботов и заказное ПО для бизнеса. Основатель — Бекзод Мирзаалиев.",
          ...
          "Чтобы начать, вам необязательно сразу что-то покупать: сначала на бесплатной консультации мы вместе оценим, подходит ли вашему бизнесу ИИ-агент и какую пользу вы можете из него извлечь.",
        ],
      },
    ],
    faq: {
      ...
      items: [
        {
          ...
          a: "ИИ-агент — это программа, которая не просто отвечает, а выполняет задачу. Он отвечает клиенту, записывает данные в CRM или 1С, оформляет заказ и при необходимости передаёт сотруднику. В основе — большая языковая модель вроде GPT или Claude, ваша база знаний и интеграция с бизнес-системами.",
        },
        {
          q: "Чем ИИ-агент отличается от чат-бота?",
          a: "Чат-бот отвечает на вопрос текстом и на этом останавливается. ИИ-агент действует: проверяет остаток на складе, создаёт заказ, записывает данные в систему и передаёт сложный случай оператору. Проще говоря: чат-бот разговаривает, агент выполняет работу.",
        },
        {
          q: "Какому бизнесу нужен ИИ-агент?",
          a: "Бизнесам с большим количеством повторяющихся вопросов и процессов — торговле и e-commerce, клиникам, ресторанам, образованию, красоте и сфере услуг. Если вы по десятку раз в день отвечаете на одни и те же вопросы, вечером лиды остаются без ответа или вы вручную переносите данные между системами — ИИ-агент будет полезен.",
        },
        {
          q: "Работает ли ИИ-агент с существующими CRM, 1С или Telegram?",
          a: "Да. Правильно построенный ИИ-агент через интеграцию работает с существующими CRM, 1С, складской базой, сайтом и Telegram. Именно эта интеграция отличает агента от обычного чат-бота — он не просто говорит, а реально действует в ваших системах.",
        },
        {
        ...
        {
          q: "За какое время будет готов ИИ-агент?",
    ...
    cta: {
      title: "Думаете о создании ИИ-агента для вашего бизнеса?",
      subtitle:
        "Команда Tezcode проанализирует ваш бизнес и вместе оценит, подходит ли вам ИИ-агент и какую пользу вы можете извлечь. Получите бесплатную консультацию.",
