    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "С AI: добавляется AI-слой, понимающий свободный вопрос и отвечающий по вашей базе.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Mini App магазин (с оплатой): выше по объёму, после ТЗ.",
          "AI-слой (свободные вопросы-ответы): AI-чат-бот от $339 — добавляется к Telegram-боту.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "4. Запуск + поддержка: подключаем каналы и CRM, поддерживаем и далее.",
        ],
      },
    ],
    faq: {
      ...
      items: [
        {
          ...
          a: "Это программа, которая автоматически работает с клиентами в Telegram: принимает заказы, берёт оплату через Click/Payme, отвечает на вопросы 24/7 и пишет данные в CRM — без оператора. Удобно, потому что в Узбекистане Telegram используют больше всего.",
        },
        {
          q: "Сколько стоит Telegram-бот (2026)?",
          a: "Простой бот заказов/FAQ от $279. С Mini App магазином (с оплатой) и AI-слоем цена растёт. AI-чат-бот от $339, интеграция CRM от $700. Точная сумма — письменно после бесплатной консультации и ТЗ.",
        },
        {
        ...
        {
          q: "Можно добавить AI к боту?",
          a: "Да. Простой кнопочный бот работает по меню; с AI-слоем бот понимает свободный вопрос на естественном языке и отвечает по вашей базе (на узбекском и русском). Многие начинают с простого бота и потом добавляют AI.",
        },
        {
        ...
        },
        {
          ...
          a: "Простой бот заказов/FAQ 1–2 недели. Сложный, с оплатой, Mini App или AI-слоем — 2–4 недели. Срок жёстко фиксируется в ТЗ.",
        },
        {
          q: "Кто делает Telegram-бот для бизнеса в Ташкенте?",
          a: "Tezcode — AI Software Factory в Ташкенте и резидент IT Park — создаёт Telegram-ботов и Mini App магазины для бизнеса (заказы, оплата Click/Payme, интеграция CRM, AI-слой). Подробнее: tezcode.dev/ru/telegram-bot-biznes.",
        },
      ],
    },
    cta: {
