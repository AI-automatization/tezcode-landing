...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      ...
      subtitle:
        "Что такое искусственный интеллект (AI), какие услуги есть для бизнеса — чат-бот, AI-агент, автоматизация процессов, видеоаналитика, голосовые ассистенты, документный AI — сколько они стоят и как выбрать подрядчика — практическое руководство.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Важный момент: искусственный интеллект — не магия, а инструмент. Он приносит реальную пользу, только когда наполнен вашими данными (цены, каталог, правила) и подключён к вашим системам (CRM, 1С, Telegram). Поэтому важнее не «поставить AI», а решить, какой процесс вы решаете с помощью искусственного интеллекта.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Полный список этих направлений собран на странице AI-автоматизации Tezcode (tezcode.dev/ai-avtomatizatsiya); отдельные страницы по чат-ботам и агентам — tezcode.dev/ai-chatbot и tezcode.dev/ai-agent.",
        ],
        bullets: [
          "AI-чат-бот — отвечает клиентам 24/7 на узбекском/русском в Telegram, Instagram, WhatsApp и на сайте, беря ответы из вашей базы знаний (цены, каталог, FAQ). Самая заказываемая услуга искусственного интеллекта.",
          "AI-агент — на шаг дальше чат-бота: не просто отвечает, а выполняет работу — проверяет остатки, записывает заказ в CRM/1С, отправляет счёт, передаёт сложный случай оператору.",
          ...
          "AI-видеоаналитика — делает ваши существующие IP-камеры «умными»: подсчёт людей (footfall), посещаемость по распознаванию лиц, контроль охраны труда, чтение автономеров (ANPR). Новые камеры не нужны.",
          ...
          "Документный AI — автоматическое чтение, сортировка и ввод в систему данных из договоров, счетов, заявлений и других документов. Особенно полезно бухгалтерии и юридическим отделам.",
      ...
      },
      {
        ...
        bullets: [
          "AI-чат-бот (Telegram, Instagram, WhatsApp, сайт) — от $339.",
          "AI-агент (сам выполняет работу, пишет в CRM/1С) — от $400.",
          ...
          "AI-видеоаналитика (подсчёт людей, посещаемость, ANPR) — от $990, разовое подключение.",
          "Заказное AI-приложение (custom) — MVP от $1000, полная цена после ТЗ.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "2. Выберите одно направление — не всё сразу: сначала, например, AI-чат-бот, а когда виден результат — добавляется агент или автоматизация.",
      ...
      },
      {
        ...
        paragraphs: [
          "Tezcode — команда AI Software Factory из 16 человек, основанная в Ташкенте в 2024 году. Мы делаем все перечисленные выше услуги искусственного интеллекта: AI-чат-боты и AI-агенты, автоматизацию процессов, AI-видеоаналитику, интеграцию CRM/1С и заказные AI-приложения.",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Стартовые цены в Узбекистане в 2026 году: AI-чат-бот от $339, AI-агент от $400, Telegram-бот от $279, автоматизация процессов от $400, интеграция CRM/1С от $700, AI-видеоаналитика от $990, заказное AI-приложение (MVP) от $1000. Точная цена зависит от каналов, интеграций и сложности — письменное предложение даётся после ТЗ.",
        },
        {
        ...
        },
        {
          ...
          a: "Если вы по десятку раз в день отвечаете на одни и те же вопросы, клиенты вечером остаются без ответа или вы вручную переносите данные — да, польза будет. Порог входа для малого бизнеса невысокий: Telegram-бот от $279, AI-чат-бот от $339. Важен не большой бюджет, а одно правильно выбранное направление.",
        },
        {
        ...
        },
        {
          ...
          a: "Зависит от сложности: простой AI-чат-бот или Telegram-бот — относительно быстро, AI-агент с многими интеграциями или видеоаналитика — дольше. Рабочая MVP-версия заказного AI-приложения обычно готова за 2-4 недели. Точный срок называется после этапа анализа.",
        },
      ],
    },
    cta: {
