...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      badge: "AI чат-бот / Сравнение",
      title: "AI чат-бот или живой оператор: что и когда? (2026)",
      subtitle:
        "AI чат-бот дёшев и быстр, живой оператор силён в деликатных ситуациях. Сравниваем по цене, скорости и качеству и определяем, что (или оба) нужно вашему бизнесу.",
    ...
    tldr: {
      ...
      text:
        "AI чат-бот отвечает клиенту за секунды (обычно до 2 секунд) и очень дёшево за один диалог; живой оператор отвечает в среднем за 2–3 минуты, и каждый простой запрос стоит дорого (зарплата оператора). Практический ответ в 2026 — почти всегда ГИБРИДНАЯ модель: повторяющиеся частые вопросы (цена, часы работы, наличие, статус заказа) берёт на себя AI чат-бот 24/7, а сложные и деликатные случаи (жалоба, крупная сделка, индивидуальная консультация) передаёт живому оператору. Тогда операторы фокусируются на самой ценной, человеческой работе, а дешёвые повторы автоматизируются.",
    },
    sections: [
      {
        heading: "Главное отличие: скорость и цена",
        paragraphs: [
          "Самое большое различие между AI чат-ботом и живым оператором — в скорости и цене:",
        ],
        bullets: [
          "Скорость: AI чат-бот отвечает за секунды (24/7, ночью и в праздники). Живой оператор — в среднем за 2–3 минуты и только в рабочее время.",
          "Цена: один диалог с AI чат-ботом очень дёшев. Каждый простой запрос к живому оператору стоит дорого за счёт зарплаты.",
          "Объём: AI чат-бот ведёт неограниченное число диалогов одновременно. Оператор говорит с 1–3 клиентами сразу.",
        ],
      },
      {
        heading: "Где силён живой оператор?",
        paragraphs: [
          "AI чат-бот не заменяет всё. Живой оператор необходим в таких случаях:",
        ],
        bullets: [
          ...
          "Нестандартные вопросы вне базы: AI не должен выдумывать то, чего не знает — передаёт оператору.",
        ],
      },
      {
        heading: "Где силён AI чат-бот?",
        paragraphs: [
          "AI чат-бот незаменим в повторяющихся, частых задачах:",
        ],
        bullets: [
      ...
      {
        heading: "Правильный ответ — гибрид (AI + оператор)",
        paragraphs: [
          "В 2026 самая эффективная модель — использовать оба. AI чат-бот становится первым слоем: принимает все запросы, простые решает сам, сложные передаёт оператору с полной историей диалога.",
          ...
          "Tezcode строит именно такие гибридные AI чат-боты — на узбекском и русском, с интеграцией CRM/1C. Подробнее: tezcode.dev/ru/ai-chatbot.",
        ],
      },
    ],
    faq: {
      ...
      items: [
        {
          q: "AI чат-бот полностью заменяет живого оператора?",
          a: "Нет, и это не нужно. AI чат-бот берёт повторяющиеся частые вопросы (цена, часы работы, заказ) 24/7; деликатные и сложные случаи (жалоба, крупная сделка) идут к оператору. Лучший результат — оба вместе (гибридная модель).",
        },
        {
          q: "Насколько быстро отвечает AI чат-бот?",
        ...
        {
          q: "AI чат-бот дешевле оператора?",
          a: "Да. Один диалог с AI чат-ботом очень дёшев, а каждый простой запрос к оператору дорог за счёт зарплаты. Поэтому выгодно отдать повторяющиеся вопросы AI, а операторов направить только на ценную работу.",
        },
        {
          q: "Как чат-бот передаёт клиента оператору?",
          a: "Если клиент просит оператора или вопрос сложный/деликатный, AI передаёт диалог живому оператору с полной историей переписки. Оператор видит контекст и продолжает — клиент ничего не объясняет заново.",
        },
        {
          q: "Мне нужен чат-бот или достаточно оператора?",
          a: "Если клиенты часто задают одни и те же вопросы, операторы не успевают отвечать или вечером/в праздники запросы остаются без ответа — AI чат-бот быстро окупается. Если в день несколько уникальных глубоких запросов — достаточно оператора. Определим на бесплатной консультации.",
        },
      ],
    },
    cta: {
