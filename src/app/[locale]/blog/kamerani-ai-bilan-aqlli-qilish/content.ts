...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      badge: "AI видеоаналитика / Руководство",
      title: "Сделайте камеры умными с AI: подсчёт людей, посещаемость и безопасность (2026)",
      subtitle:
        "У вас есть камеры, но они только записывают. AI-видеоаналитика делает их умными: считает людей, ведёт учёт посещаемости по лицу, контролирует безопасность. Новые камеры не нужны.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Главное преимущество: AI-слой добавляется поверх ваших существующих камер.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "AI-видеоаналитика подходит разным отраслям:",
        ],
        bullets: [
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Нет. AI-слой работает с вашими существующими IP-камерами (Hikvision, Dahua и др.). Камеры и NVR остаются на месте, добавляется только программный слой. Это гораздо экономнее покупки новой системы.",
        },
        {
          q: "Как работает подсчёт людей в магазине?",
          a: "AI определяет людей на изображении с камеры и считает зашедших/вышедших. В итоге вы получаете точную цифру footfall по дням и часам — для часов пик, плана смен и конверсии (сколько зашло и сколько купило).",
        },
        {
        ...
        {
          q: "Сколько это стоит?",
          a: "AI-видеоаналитика от $990 — это разовое подключение. Работает с вашими существующими камерами, дальше системой управляете сами. Точная цена зависит от числа камер и задач (подсчёт людей, посещаемость, ANPR).",
        },
        {
          q: "Кто делает камеры умными с AI в Ташкенте?",
          a: "Tezcode — AI Software Factory в Ташкенте и резидент IT Park — делает существующие камеры умными с AI: подсчёт людей, посещаемость по лицу, охрана труда, ANPR. Подробнее: tezcode.dev/ru/ai-video-analitika.",
        },
      ],
    },
    cta: {
      title: "Сделаем ваши камеры умными с AI?",
      subtitle:
        "На бесплатной консультации Tezcode посмотрит ваши существующие камеры и определит, какие возможности AI (подсчёт людей, посещаемость, ANPR) дадут вам пользу. Без обязательств.",
