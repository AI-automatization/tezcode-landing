...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      badge: "Мир AI / Новость",
      title: "Claude Fable 5: самая мощная модель Anthropic и что это значит для бизнеса",
      subtitle:
        "Anthropic выпустила Claude Fable 5, временно приостановила доступ из-за экспортного контроля США, а затем снова открыла её глобально. Взгляд Tezcode — что это значит для проектов AI-автоматизации в Узбекистане.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Цена тоже примечательна: $10 за 1 млн входных токенов, $50 за выходные — более чем вдвое дешевле предыдущей Claude Mythos Preview. Более мощная модель по более низкой цене имеет прямое практическое значение для проектов AI-автоматизации.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "Каждый раз, когда выходит более мощная и более дешёвая модель, стоимость AI-автоматизации (чат-боты, AI-агенты, автоматизация процессов) снижается, а качество растёт. Компании вроде Tezcode могут использовать именно такие передовые модели, чтобы предлагать клиентам более быстрые и качественные решения.",
          "Эта история также показала: вопрос безопасности при внедрении мощных AI-моделей остаётся серьёзным — даже такая ведущая компания, как Anthropic, столкнулась с временными ограничениями. Учитывать меры безопасности с самого начала при построении AI-агентов — это не разовая мера, а постоянное требование.",
        ],
      },
    ],
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Tezcode использует самые передовые модели при создании AI-агентов и решений автоматизации для клиентов — новые, более мощные и доступные модели напрямую влияют на качество и стоимость.",
        },
      ],
    },
    cta: {
      title: "Нужен AI-агент для вашего бизнеса?",
      subtitle:
        "Tezcode строит AI-агентов и решения автоматизации для бизнеса на самых передовых моделях. Свяжитесь с нашей командой.",
