    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Учёт в тетради или Excel поначалу работает в маленьком магазине, но с ростом ассортимента остатки путаются, кражу заметить сложнее, а подсчёт в конце дня занимает часы. POS автоматизирует это: каждая продажа автоматически вычитается из остатка, дневная выручка считается сама.",
        ],
      },
      {
