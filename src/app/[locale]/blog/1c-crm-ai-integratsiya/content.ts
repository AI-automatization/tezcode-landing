...
export const CONTENT: ArticleContent = {
  ...
  ru: {
    hero: {
      ...
      subtitle:
        "В Узбекистане у многих продажи и склад в 1С, а клиенты в Telegram/Instagram. Объясняем, как связать 1С с CRM и ИИ, собрать данные в одном месте и автоматизировать процесс.",
    ...
    tldr: {
      ...
      text:
        "Интеграция 1С с CRM (amoCRM, Bitrix24) и ИИ — это синхронизация заказов, счетов и остатков из 1С с CRM и ИИ-системами через API. В результате: клиент оформил заказ в Telegram — он автоматически попал в CRM и создался документ в 1С; остатки из 1С видны в CRM; ИИ-чат-бот читает из 1С реальную цену и наличие и отвечает. Менеджер работает в CRM, бухгалтер в 1С — данные одни и автоматические. Tezcode связывает 1С с amoCRM, Bitrix24, HubSpot и ИИ-решениями; цена от $700 (разовая интеграция).",
    },
    sections: [
      {
        heading: "Зачем связывать 1С с CRM и ИИ?",
        paragraphs: [
          ...
          "Связка закрывает этот разрыв: обращение попадает в CRM, заказ автоматически уходит в 1С, а ИИ отвечает, используя данные 1С.",
        ],
      },
      {
        heading: "Как это работает?",
        paragraphs: [
          "Интеграция строится через API — 1С и CRM/ИИ обмениваются данными. Практические сценарии:",
        ],
        bullets: [
          "Синхронизация заказов: заказ, оформленный в CRM (или чат-боте), создаётся документом в 1С — без повторного ввода.",
          "Остатки и цены: остаток на складе и прайс из 1С передаются в CRM и ИИ-чат-бот, поэтому клиент получает точную, реальную информацию.",
          "Счета: после подтверждения заказа 1С создаёт счёт, статус возвращается в CRM.",
          "ИИ читает: ИИ-чат-бот или агент берёт из 1С товар, цену и наличие и отвечает клиенту на естественном языке («есть этот товар, сколько стоит?»).",
        ],
      },
      {
      ...
      {
        heading: "1С и ИИ: что возможно?",
        paragraphs: [
          "Не только CRM — поверх 1С можно надстроить и ИИ-слой:",
        ],
        bullets: [
          "ИИ-чат-бот читает из 1С реальную цену и остаток и отвечает клиенту 24/7.",
          "ИИ-агент принимает заказ, создаёт документ в 1С и запускает доставку.",
          "ИИ читает отчёты 1С и даёт анализ продаж и выводы простым языком.",
          "Важно: ИИ не заменяет 1С — надстраивается сверху и делает её умнее.",
        ],
      },
      {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "Нет. Интеграция строится поверх вашей существующей 1С — не заменяет её. Мы связываем 1С с CRM и ИИ, поэтому ваша рабочая система сохраняется и только усиливается.",
        },
        {
          q: "Может ли ИИ-чат-бот читать цену и остаток из 1С?",
          a: "Да. При правильной настройке ИИ-чат-бот или агент читает из 1С реальную цену и остаток на складе и даёт клиенту точный ответ — на вопросы вроде «есть ли этот товар, сколько стоит» с реальными данными.",
        },
        {
    ...
    cta: {
      title: "Хотите связать 1С с CRM и ИИ?",
      subtitle:
