...
export const CONTENT: ServicePageContent = {
  ...
  ru: {
    hero: {
      ...
      title2: "продукты",
      subtitle:
        "TezCode Labs — внутренняя инновационная лаборатория и венчурная студия Tezcode. Мы не только разрабатываем для клиентов — мы рождаем, валидируем и масштабируем собственные стартапы. WeWatch, CoreMed, Ventra и другие родились здесь.",
    ...
    capabilities: {
      ...
      items: [
        ...
        { icon: "rocket", title: "Разработка MVP", desc: "Полноценная первая версия для реальных пользователей. Разработка, ускоренная с помощью AI." },
    ...
    process: {
      ...
      steps: [
        ...
        { num: "03", title: "MVP", desc: "Первый рабочий продукт на рынок. С AI-ускоренной разработкой в короткий срок.", icon: "rocket" },
    ...
    examples: {
      ...
      items: [
        ...
        { tag: "AI-Trade / MaxSavdo", title: "AI и commerce", desc: "AI-Trade и MaxSavdo — наши экспериментальные продукты в сфере торговли и commerce. Проверены через dogfooding." },
      ],
    },
    cta: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "На каком этапе вы подключаетесь?", a: "На разных: от чистой идеи к валидации, от прототипа к MVP или масштабирования существующего продукта. Этап оцениваем вместе, затем согласуем форму партнёрства." },
        { q: "Чем это отличается от обычной (custom) разработки?", a: "В custom вы платите, мы разрабатываем как подрядчик, и код ваш. В Labs мы становимся партнёром: берём риск вместе, вкладываем ресурсы и инвестиции и привязаны к результату через долю в стартапе." },
        { q: "Почему внутренняя лаборатория важна?", a: "Потому что мы сами строим и используем свои продукты (dogfooding). Это даёт нам проверенный playbook, реальный продуктовый опыт и AI-ускоренную разработку — которые мы приносим и фаундерам." },
      ],
    },
    related: {
      badge: "Подробнее",
      ...
      links: [
        ...
        { href: "/ai-agent", label: "AI-агенты", desc: "AI-ускоренная разработка и автоматизация." },
      ],
    },
    service: {
