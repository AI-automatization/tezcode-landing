...
const PARTNERS: Partner[] = [
  ...
  },
  {
    id: "frontix",
    name: "FRONTIX",
    logoUrl: "/partners/frontix-og-banner.png",
    media: "banner",
    href: "/partnery/frontix",
    role: {
      uz: "Veb va raqamli mahsulotlar hamkori",
      ru: "Партнёр по веб- и цифровым продуктам",
      en: "Web and digital product partner",
      ar: "شريك في منتجات الويب والمنتجات الرقمية",
      uk: "Партнер з вебу та цифрових продуктів",
    },
    description: {
      uz: "FRONTIX — Toshkentdagi IT kompaniya: sayt, QR menyu, Telegram bot va onlayn buyurtma tizimlari. Tezcode ustiga AI qatlamini qo'shadi.",
      ru: "FRONTIX — IT-компания в Ташкенте: сайты, QR-меню, Telegram-боты и системы онлайн-заказов. Tezcode добавляет сверху слой ИИ.",
      en: "FRONTIX is a Tashkent IT company building websites, QR menus, Telegram bots and online ordering systems. Tezcode adds the AI layer on top.",
      ar: "FRONTIX شركة تقنية في طشقند تبني المواقع وقوائم QR وبوتات تيليغرام وأنظمة الطلب عبر الإنترنت، وتضيف Tezcode طبقة الذكاء الاصطناعي فوقها.",
      uk: "FRONTIX — IT-компанія в Ташкенті: сайти, QR-меню, Telegram-боти та системи онлайн-замовлень. Tezcode додає згори шар AI.",
    },
    tags: {
      uz: ["Sayt", "QR menyu", "Telegram bot"],
      ru: ["Сайты", "QR-меню", "Telegram-бот"],
      en: ["Websites", "QR menus", "Telegram bots"],
      ar: ["مواقع", "قوائم QR", "بوتات تيليغرام"],
      uk: ["Сайти", "QR-меню", "Telegram-бот"],
    },
  },
  {
    id: "schwarz-digits",
