      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        {open && (
          <div className="flex flex-col gap-2 animate-tc-fade-up">
            ...
            <a
              href="https://wa.me/998999414242"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-4 py-3 rounded-full bg-[#25D366] text-white shadow-xl hover:scale-105 transition-transform text-sm font-500"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          aria-label={t("label")}
          className="w-14 h-14 rounded-full bg-[var(--tc-blue)] text-white shadow-xl hover:scale-110 transition-transform flex items-center justify-center tc-glow-blue"
        >
          {open ? (
