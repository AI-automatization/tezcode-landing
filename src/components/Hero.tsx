...
const VISUAL_COPY: Record<string, VisualCopy> = {
  ...
  ru: {
    ...
    slides: [
      {
        title: "AI-чатбот",
        desc: "AI сам отвечает на каждый вопрос клиента 24/7.",
      ...
      {
        title: "AI-звонки",
        desc: "Voice AI сам отвечает на звонки и принимает заказы.",
        tasks: ["Автоответ на звонки", "Запись заказа", "Расшифровка разговора в текст"],
        oldLabel: "30% звонков упущено",
        newLabel: "100% ответов",
      },
      {
        title: "AI-анализ продаж",
        desc: "AI изучает ваши продажи и подсказывает, что делать.",
        tasks: ["Какой товар идёт лучше", "Рекомендации по ценам", "Предупреждение об остатках"],
        oldLabel: "Решения по наитию",
        newLabel: "Решения с AI-анализом",
      },
      {
        title: "AI-отчёты и прогноз",
      ...
      {
        title: "AI-документы",
        desc: "AI читает, заполняет и проверяет документы.",
      ...
      {
        title: "AI-маркетинг",
        desc: "Посты, объявления и описания AI пишет сам.",
      ...
      {
        title: "AI-запись и очередь",
        desc: "Запись и очередь управляет AI — клиника, салон, сервис.",
        tasks: ["Онлайн-запись", "Распределение очереди", "SMS-напоминания"],
        oldLabel: "Очередь: 40 минут",
        newLabel: "На 40% быстрее",
      },
      {
        title: "AI-анализ команды",
        desc: "AI следит за эффективностью команды и делает выводы.",
        tasks: ["Посещаемость и активность", "Распределение задач", "Еженедельная AI-сводка"],
        oldLabel: "Контроль: 1 час/день",
        newLabel: "Само собой",
      },
      {
        title: "AI-агенты",
        desc: "AI-агент сам ведёт весь процесс от начала до конца.",
