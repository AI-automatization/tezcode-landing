    ...
    items: [
      {
        ...
        a: "Tezcode — AI Software Factory в Ташкенте. Мы разрабатываем ИИ-автоматизацию для бизнеса, ИИ-агентов, чат-ботов, POS-системы, CRM для клиник и заказные программы. Основана в 2024 году, резидент IT Park.",
      },
      {
        q: "Какие продукты предлагает Tezcode?",
        a: "Готовые продукты: RAOS (POS-система для магазинов), ClinicaGo (CRM для клиник), WorkControl (контроль сотрудников), HamshiraGo (медицинская платформа) и WeWatch. А также заказная разработка и услуги ИИ-автоматизации.",
      },
      {
        q: "Какие ИИ-технологии использует Tezcode?",
    ...
    items: [
      {
        ...
        a: "Цена зависит от модели и объёма. Готовые SaaS-продукты — по месячной подписке, заказные программы — по проекту (предоплата 30%), ИИ-автоматизация — по охвату. Для точной цены закажите бесплатную консультацию.",
      },
      {
        q: "Какие модели ценообразования есть?",
        a: "Три модели: (1) готовый SaaS-продукт — месячная подписка; (2) заказная программа — цена проекта, 30% предоплата; (3) ИИ-автоматизация — в зависимости от охвата и интеграций.",
      },
      {
